...
const LEGACY_SESSION_KEY_COMPAT = Symbol.for("mechanical-wings.contextEngine.sessionKeyCompat");
...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("mechanical-wings.contextEngineRegistryState");
 ...
 */
export async function resolveContextEngine(config?: WingsConfig): Promise<ContextEngine> {
