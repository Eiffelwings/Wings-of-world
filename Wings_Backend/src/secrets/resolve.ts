...
function resolveResolutionLimits(config: WingsConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: WingsConfig): SecretProviderConfig {
