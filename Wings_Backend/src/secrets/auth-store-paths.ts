...
export function listAuthProfileStorePaths(config: WingsConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: WingsConfig, stateDir: string): string[] {
