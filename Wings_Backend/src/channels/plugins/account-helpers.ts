...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: WingsConfig): string | undefined {
  ...
  function listAccountIds(cfg: WingsConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: WingsConfig): string {
