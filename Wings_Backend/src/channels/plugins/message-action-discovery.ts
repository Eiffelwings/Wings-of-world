...
export function listChannelMessageActions(cfg: WingsConfig): ChannelMessageActionName[] {
...
export function listChannelMessageCapabilities(cfg: WingsConfig): ChannelMessageCapability[] {
