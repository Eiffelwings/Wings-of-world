...
export type ChannelSetupWizardStatus = {
  ...
  resolveConfigured: (params: { cfg: WingsConfig }) => boolean | Promise<boolean>;
...
export type ChannelSetupWizardEnvShortcut = {
  ...
  isAvailable: (params: { cfg: WingsConfig; accountId: string }) => boolean;
  apply: (params: {
    cfg: WingsConfig;
    accountId: string;
...
export type ChannelSetupWizardCredential = {
  ...
  keepPrompt: string;
  inputPrompt: string;
  allowEnv?: (params: { cfg: WingsConfig; accountId: string }) => boolean;
  inspect: (params: {
    cfg: WingsConfig;
    accountId: string;
...
export type ChannelSetupWizardGroupAccess = {
  ...
  currentPolicy: (params: { cfg: WingsConfig; accountId: string }) => ChannelAccessPolicy;
  currentEntries: (params: { cfg: WingsConfig; accountId: string }) => string[];
  updatePrompt: (params: { cfg: WingsConfig; accountId: string }) => boolean;
  setPolicy: (params: {
    cfg: WingsConfig;
    accountId: string;
...
export type ChannelSetupWizard = {
  ...
  disable?: (cfg: WingsConfig) => WingsConfig;
