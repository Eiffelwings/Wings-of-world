...
export type ChannelConfigAdapter<ResolvedAccount> = {
  ...
  resolveAccount: (cfg: WingsConfig, accountId?: string | null) => ResolvedAccount;
  inspectAccount?: (cfg: WingsConfig, accountId?: string | null) => unknown;
  defaultAccountId?: (cfg: WingsConfig) => string;
  setAccountEnabled?: (params: {
    cfg: WingsConfig;
    accountId: string;
    enabled: boolean;
  }) => WingsConfig;
  deleteAccount?: (params: { cfg: WingsConfig; accountId: string }) => WingsConfig;
  isEnabled?: (account: ResolvedAccount, cfg: WingsConfig) => boolean;
  disabledReason?: (account: ResolvedAccount, cfg: WingsConfig) => string;
  isConfigured?: (account: ResolvedAccount, cfg: WingsConfig) => boolean | Promise<boolean>;
  unconfiguredReason?: (account: ResolvedAccount, cfg: WingsConfig) => string;
  describeAccount?: (account: ResolvedAccount, cfg: WingsConfig) => ChannelAccountSnapshot;
...
export type ChannelGatewayContext<ResolvedAccount = unknown> = {
   ...
   * @see {@link https://docs.wings-of-world.ai/plugins/developing-plugins | Plugin SDK documentation}
   */
...
export type ChannelHeartbeatAdapter = {
  ...
  resolveRecipients?: (params: { cfg: WingsConfig; opts?: { to?: string; all?: boolean } }) => {
    recipients: string[];
    source: string;
  };
};
...
export type ChannelExecApprovalAdapter = {
  ...
  hasConfiguredDmRoute?: (params: { cfg: WingsConfig }) => boolean;
...
export type ChannelAllowlistAdapter = {
  applyConfigEdit?: (params: {
    ...
    | Promise<
      ...
      >
    | null;
  readConfig?: (params: { cfg: WingsConfig; accountId?: string | null }) =>
    | {
