...
import { writeConfigFile, type WingsConfig } from "../../config/config.js";
...
function resolveCatalogChannelEntry(raw: string, cfg: WingsConfig | null) {
...
export async function channelsAddCommand(
  ...
  // May trigger loadWingsPlugins on cache miss (disk scan + jiti import)
