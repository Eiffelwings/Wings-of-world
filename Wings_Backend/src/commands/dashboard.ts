...
export async function dashboardCommand(
  ...
  if (resolvedToken.unresolvedRefReason) {
    ...
    runtime.log(
      "Set WINGS_OF_WORLD_BACKEND_GATEWAY_TOKEN in this shell or resolve your secret provider, then rerun `wings-of-world-backend dashboard`.",
    );
  }
  ...
  if (opened) {
    runtime.log("Opened in your browser. Keep that tab to control Wings.");
  } else if (hint) {
    runtime.log(hint);
  }
}
