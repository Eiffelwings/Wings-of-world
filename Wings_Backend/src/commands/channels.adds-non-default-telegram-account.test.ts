  ...
  it.each([
    {
      ...
      patterns: [
        ...
        /Run: (?:mechanical-wings|mechanical-wings)( --profile isolated)? doctor/,
      ],
    },
    {
      ...
      telegram: [
        {
          ...
          enabled: true,
          configured: true,
          probe: { ok: true, bot: { username: "mechanical-wings_bot" } },
        },
      ],
    });
    expect(joined).toMatch(/bot:@mechanical-wings_bot/);
  });
