...
export function summarizeExistingConfig(config: WingsConfig): string {
  const rows: string[] = [];
...
export function formatControlUiSshHint(params: {
  ...
  return [
    ...
    authedUrl,
    "Docs:",
    "https://docs.wings-of-world.ai/gateway/remote",
    "https://docs.wings-of-world.ai/web/control-ui",
  ]
    .filter(Boolean)
    .join("\n");
}
