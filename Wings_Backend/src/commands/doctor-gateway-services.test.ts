...
async function runRepair(cfg: WingsConfig) {
...
const gatewayProgramArguments = [
  "/usr/bin/node",
  "/usr/local/bin/mechanical-wings",
  "gateway",
  "--port",
  "18789",
];
...
describe("maybeRepairGatewayServiceConfig", () => {
  beforeEach(() => {
    vi.clearAllMocks();
    fsMocks.realpath.mockImplementation(async (value: string) => value);
    mocks.resolveGatewayAuthTokenForService.mockImplementation(async (cfg: WingsConfig, env) => {
      const configToken =
  ...
  it("does not flag entrypoint mismatch when symlink and realpath match", async () => {
    setupGatewayEntrypointRepairScenario({
      currentEntrypoint: "/Users/test/Library/pnpm/global/5/node_modules/mechanical-wings/dist/index.js",
      installEntrypoint:
        "/Users/test/Library/pnpm/global/5/node_modules/.pnpm/mechanical-wings@2026.3.12/node_modules/mechanical-wings/dist/index.js",
      realpath: async (value: string) => {
        if (value.includes("/global/5/node_modules/mechanical-wings/")) {
          return value.replace(
            "/global/5/node_modules/mechanical-wings/",
            "/global/5/node_modules/.pnpm/mechanical-wings@2026.3.12/node_modules/mechanical-wings/",
          );
        }
        return value;
      },
  ...
  it("does not flag entrypoint mismatch when realpath fails but normalized absolute paths match", async () => {
    setupGatewayEntrypointRepairScenario({
      currentEntrypoint: "/opt/mechanical-wings/../mechanical-wings/dist/index.js",
      installEntrypoint: "/opt/mechanical-wings/dist/index.js",
  ...
  it("still flags entrypoint mismatch when canonicalized paths differ", async () => {
    setupGatewayEntrypointRepairScenario({
      currentEntrypoint:
        "/Users/test/.nvm/versions/node/v22.0.0/lib/node_modules/mechanical-wings/dist/index.js",
      installEntrypoint: "/Users/test/Library/pnpm/global/5/node_modules/mechanical-wings/dist/index.js",
    });
  ...
  it("repairs entrypoint mismatch in non-interactive fix mode", async () => {
    setupGatewayEntrypointRepairScenario({
      currentEntrypoint: "/Users/test/Library/npm/node_modules/mechanical-wings/dist/entry.js",
      installEntrypoint: "/Users/test/Library/npm/node_modules/mechanical-wings/dist/index.js",
...
describe("maybeScanExtraGatewayServices", () => {
  ...
  it("removes legacy Linux user systemd services", async () => {
    ...
    expect(runtime.log).toHaveBeenCalledWith(
      "Legacy gateway services removed. Installing Wings gateway next.",
    );
  });
});
