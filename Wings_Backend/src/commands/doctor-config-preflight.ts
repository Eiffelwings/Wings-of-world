...
async function maybeMigrateLegacyConfig(): Promise<string[]> {
  ...
  const targetDir = path.join(home, ".wings-of-world-backend");
  const targetPath = path.join(targetDir, "wings-of-world.json");
  try {
  ...
  const legacyCandidates = [
    path.join(home, ".mechanical-wings", "mechanical-wings.json"),
