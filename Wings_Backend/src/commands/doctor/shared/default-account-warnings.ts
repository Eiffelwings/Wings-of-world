...
export function collectMissingDefaultAccountBindingWarnings(cfg: WingsConfig): string[] {
...
export function collectMissingExplicitDefaultAccountWarnings(cfg: WingsConfig): string[] {
  const warnings: string[] = [];
