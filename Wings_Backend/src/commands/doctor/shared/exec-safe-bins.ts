...
function collectExecSafeBinScopes(cfg: WingsConfig): ExecSafeBinScopeRef[] {
...
export function scanExecSafeBinCoverage(cfg: WingsConfig): ExecSafeBinCoverageHit[] {
...
export function maybeRepairExecSafeBinProfiles(cfg: WingsConfig): {
  config: WingsConfig;
  changes: string[];
  warnings: string[];
} {
