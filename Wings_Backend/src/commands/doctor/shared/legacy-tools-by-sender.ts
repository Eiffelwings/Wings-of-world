...
export function scanLegacyToolsBySenderKeys(cfg: WingsConfig): LegacyToolsBySenderKeyHit[] {
...
export function maybeRepairLegacyToolsBySenderKeys(cfg: WingsConfig): {
  config: WingsConfig;
  changes: string[];
} {
