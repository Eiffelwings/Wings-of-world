...
async function inspectHealthAccount(plugin: ChannelPlugin, cfg: WingsConfig, accountId: string) {
  return (
...
export async function healthCommand(
  opts: { json?: boolean; timeoutMs?: number; verbose?: boolean; config?: WingsConfig },
  runtime: RuntimeEnv,
) {
