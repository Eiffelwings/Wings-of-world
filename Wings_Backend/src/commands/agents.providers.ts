...
function resolveDefaultAccountId(cfg: WingsConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: WingsConfig): boolean {
...
export function summarizeBindings(cfg: WingsConfig, bindings: AgentBinding[]): string[] {
