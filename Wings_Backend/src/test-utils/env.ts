...
const PATH_RESOLUTION_ENV_KEYS = [
  ...
  "WINGS_OF_WORLD_BUNDLED_PLUGINS_DIR",
  "OPENCLAW_HOME",
  "OPENCLAW_STATE_DIR",
...
export function createPathResolutionEnv(
  ...
  const nextEnv: NodeJS.ProcessEnv = {
    ...
    WINGS_OF_WORLD_BACKEND_HOME: undefined,
    WINGS_OF_WORLD_HOME: undefined,
    WINGS_OF_WORLD_BACKEND_STATE_DIR: undefined,
    WINGS_OF_WORLD_STATE_DIR: undefined,
    WINGS_OF_WORLD_BACKEND_BUNDLED_PLUGINS_DIR: undefined,
    WINGS_OF_WORLD_BUNDLED_PLUGINS_DIR: undefined,
