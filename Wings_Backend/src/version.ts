...
const CORE_PACKAGE_NAMES = new Set(["wings-of-world-backend", "mechanical-wings"]);
...
function resolveVersionFromRuntimeSources(params: {
  ...
  const preferredCandidates =
    params.preference === "env-first"
      ? [
          params.env["WINGS_OF_WORLD_BACKEND_VERSION"],
          params.env["WINGS_OF_WORLD_VERSION"],
          params.env["OPENCLAW_VERSION"],
  ...
  return (
    firstNonEmpty(
      ...preferredCandidates,
      params.env["WINGS_OF_WORLD_BACKEND_SERVICE_VERSION"],
      params.env["WINGS_OF_WORLD_SERVICE_VERSION"],
...
// Single source of truth for the current Wings version.
...
export const VERSION = resolveBinaryVersion({
  ...
  bundledVersion:
    process.env.WINGS_OF_WORLD_BACKEND_BUNDLED_VERSION ??
    process.env.WINGS_OF_WORLD_BUNDLED_VERSION ??
