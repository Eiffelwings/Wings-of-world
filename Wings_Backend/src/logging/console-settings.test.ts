...
let originalWingsTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalWingsTestConsole = process.env.OPENCLAW_TEST_CONSOLE;
...
afterEach(() => {
  ...
  if (originalWingsTestConsole === undefined) {
    delete process.env.OPENCLAW_TEST_CONSOLE;
  } else {
    process.env.OPENCLAW_TEST_CONSOLE = originalWingsTestConsole;
  }
