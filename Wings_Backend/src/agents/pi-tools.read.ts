...
function resolveAdaptiveReadMaxBytes(options?: WingsReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createWingsReadTool(base, {
...
export function createWingsReadTool(
  base: AnyAgentTool,
  options?: WingsReadToolOptions,
): AnyAgentTool {
