...
function buildCoreToolGroupMap() {
  ...
  const mechanicalWingsTools = CORE_TOOL_DEFINITIONS.filter((tool) => tool.includeInWingsGroup).map(
    (tool) => tool.id,
  );
  return {
    "group:mechanical-wings": mechanicalWingsTools,
