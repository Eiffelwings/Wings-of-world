...
export function resolveDefaultAgentWorkspaceDir(
  ...
  if (profile && profile.toLowerCase() !== "default") {
    return path.join(home, ".wings-of-world-backend", `workspace-${profile}`);
  }
  return path.join(home, ".wings-of-world-backend", "workspace");
}
...
const WORKSPACE_STATE_DIRNAME = ".wings-of-world";
