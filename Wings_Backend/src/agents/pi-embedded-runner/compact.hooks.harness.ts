...
export const createWingsCodingToolsMock = vi.fn(() => []);
...
export function resetCompactHooksHarnessMocks(): void {
  ...
  createWingsCodingToolsMock.mockReset();
...
export async function loadCompactHooksHarness(): Promise<{
  ...
  vi.doMock("../models-config.js", () => ({
    ensureWingsModelsJson: vi.fn(async () => {}),
  }));
  ...
  vi.doMock("../docs-path.js", () => ({
    resolveWingsDocsPath: vi.fn(async () => undefined),
  }));
  ...
  vi.doMock("../pi-tools.js", () => ({
    createWingsCodingTools: createWingsCodingToolsMock,
  }));
  ...
  vi.doMock("../agent-paths.js", () => ({
    resolveWingsAgentDir: vi.fn(() => "/tmp"),
  }));
