...
export function isCliProvider(provider: string, cfg?: WingsConfig): boolean {
...
function resolveAllowedFallbacks(params: { cfg: WingsConfig; agentId?: string }): string[] {
  if (params.agentId) {
...
export function buildConfiguredModelCatalog(params: { cfg: WingsConfig }): ModelCatalogEntry[] {
