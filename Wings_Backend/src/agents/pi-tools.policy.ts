...
export function resolveSubagentToolPolicy(cfg?: WingsConfig, depth?: number): SandboxToolPolicy {
...
function resolveExplicitProfileAlsoAllow(tools?: WingsConfig["tools"]): string[] | undefined {
