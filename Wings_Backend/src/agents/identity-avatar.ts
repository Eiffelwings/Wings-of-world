...
function resolveAvatarSource(cfg: WingsConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: WingsConfig, agentId: string): AgentAvatarResolution {
