...
export function createPiToolsSandboxContext(params: PiToolsSandboxContextParams): SandboxContext {
  ...
  return {
    ...
    runtimeId: params.containerName ?? "mechanical-wings-sbx-test",
    runtimeLabel: params.containerName ?? "mechanical-wings-sbx-test",
    containerName: params.containerName ?? "mechanical-wings-sbx-test",
