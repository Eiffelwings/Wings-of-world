...
export const DEFAULT_SANDBOX_IMAGE = "mechanical-wings-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "mechanical-wings-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "mechanical-wings-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "mechanical-wings-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "mechanical-wings-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "mechanical-wings-sandbox-browser";
