...
const CLEANUP_STATE_KEY = Symbol.for("mechanical-wings.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("mechanical-wings.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("mechanical-wings.sessionWriteLockWatchdogState");
