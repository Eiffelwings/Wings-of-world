...
describe("provider attribution", () => {
  it("resolves the canonical Wings product and runtime version", () => {
  ...
  it("returns a documented OpenRouter attribution policy", () => {
    ...
    expect(policy).toEqual({
      ...
      reviewNote: "Documented app attribution headers. Verified in Wings runtime wrapper.",
      product: "Wings",
      version: "2026.3.22",
      headers: {
        "HTTP-Referer": "https://wings-of-world.ai",
        "X-OpenRouter-Title": "Wings",
  ...
  it("returns a hidden-spec OpenAI attribution policy", () => {
    expect(resolveProviderAttributionPolicy("openai", { OPENCLAW_VERSION: "2026.3.22" })).toEqual({
      ...
      version: "2026.3.22",
      headers: {
        originator: "mechanical-wings",
        "User-Agent": "mechanical-wings/2026.3.22",
      },
    });
