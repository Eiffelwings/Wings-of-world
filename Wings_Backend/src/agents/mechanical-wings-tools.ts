...
const defaultWingsToolsDeps: WingsToolsDeps = {
  callGateway,
};

let openClawToolsDeps: WingsToolsDeps = defaultWingsToolsDeps;

export function createWingsTools(
  options?: {
...
export const __testing = {
  setDepsForTest(overrides?: Partial<WingsToolsDeps>) {
    openClawToolsDeps = overrides
      ? {
          ...defaultWingsToolsDeps,
          ...overrides,
        }
      : defaultWingsToolsDeps;
  },
