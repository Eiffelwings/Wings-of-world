...
function resolveAnthropicOpusThinking(cfg: WingsConfig) {
...
function createProviderWithModelsConfig(provider: string, models: Array<Record<string, unknown>>) {
  ...
  } as Partial<WingsConfig>;
}

function resolveConfiguredRefForTest(cfg: Partial<WingsConfig>) {
