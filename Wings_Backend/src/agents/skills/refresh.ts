...
function resolveWatchPaths(workspaceDir: string, config?: WingsConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: WingsConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: WingsConfig }) {
