...
type ConfiguredWebSearchProvider = NonNullable<
  NonNullable<NonNullable<WingsConfig["tools"]>["web"]>["search"]
>["provider"];

export type WebSearchConfig = NonNullable<WingsConfig["tools"]>["web"] extends infer Web
...
export function resolveSearchConfig(cfg?: WingsConfig): WebSearchConfig {
