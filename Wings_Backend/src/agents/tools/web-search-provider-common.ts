...
export type SearchConfigRecord = (NonNullable<WingsConfig["tools"]>["web"] extends infer Web
...
const SEARCH_CACHE_KEY = Symbol.for("mechanical-wings.web-search.cache");
...
export function parseIsoDateRange(params: {
  ...
  const docs = params.docs ?? "https://docs.wings-of-world.ai/tools/web";
