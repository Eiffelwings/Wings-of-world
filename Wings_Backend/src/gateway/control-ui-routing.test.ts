    ...
    it.each([
      {
        ...
        pathname: "/mechanical-wings",
        search: "?foo=1",
        method: "GET",
        expected: { kind: "redirect" as const, location: "/mechanical-wings/?foo=1" },
      },
      {
        name: "serves nested read-only routes",
        pathname: "/mechanical-wings/chat",
        search: "",
        method: "HEAD",
        expected: { kind: "serve" as const },
      },
      ...
      ...["PUT", "DELETE", "PATCH", "OPTIONS"].map((method) => ({
        ...
        pathname: "/mechanical-wings/webhook",
        search: "",
        method,
        expected: { kind: "not-control-ui" as const },
      })),
