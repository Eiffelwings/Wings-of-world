...
export function hasAmbiguousGatewayAuthModeConfig(cfg: WingsConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: WingsConfig): void {
