export const GATEWAY_CLIENT_IDS = {
  ...
  CONTROL_UI: "mechanical-wings-control-ui",
  TUI: "mechanical-wings-tui",
  WEBCHAT: "webchat",
  CLI: "cli",
  GATEWAY_CLIENT: "gateway-client",
  MACOS_APP: "mechanical-wings-macos",
  IOS_APP: "mechanical-wings-ios",
  ANDROID_APP: "mechanical-wings-android",
  NODE_HOST: "node-host",
  TEST: "test",
  FINGERPRINT: "fingerprint",
  PROBE: "mechanical-wings-probe",
} as const;
