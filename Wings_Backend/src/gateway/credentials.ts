  ...
  constructor(path: string) {
    super(
      [
        ...
        "Fix: set WINGS_OF_WORLD_BACKEND_GATEWAY_TOKEN/WINGS_OF_WORLD_BACKEND_GATEWAY_PASSWORD, pass explicit --token/--password,",
        "or use the legacy OPENCLAW_GATEWAY_TOKEN/OPENCLAW_GATEWAY_PASSWORD compatibility env vars,",
