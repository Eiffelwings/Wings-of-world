...
function resolveImportedExternalId(message: unknown): string | undefined {
  ...
  const meta =
    "__mechanical-wings" in message &&
    (message as { "__mechanical-wings"?: unknown })["__mechanical-wings"] &&
    typeof (message as { "__mechanical-wings"?: unknown })["__mechanical-wings"] === "object"
      ? ((message as { "__mechanical-wings"?: Record<string, unknown> })["__mechanical-wings"] ?? {})
      : undefined;
