...
export function collectConfiguredModelPricingRefs(config: WingsConfig): ModelRef[] {
...
function scheduleRefresh(params: { config: WingsConfig; fetchImpl: typeof fetch }): void {
  clearRefreshTimer();
