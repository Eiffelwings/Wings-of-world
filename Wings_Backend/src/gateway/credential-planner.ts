...
type GatewaySecretDefaults = NonNullable<WingsConfig["secrets"]>["defaults"];
 ...
 * This prevents literal placeholder strings like `${WINGS_OF_WORLD_BACKEND_GATEWAY_TOKEN}` from being
