...
export type Hook = {
  name: string;
  description: string;
  source: "mechanical-wings-bundled" | "mechanical-wings-managed" | "mechanical-wings-workspace" | "mechanical-wings-plugin";
  pluginId?: string;
