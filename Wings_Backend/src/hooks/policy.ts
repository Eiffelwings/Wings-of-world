import type { WingsConfig, HookConfig } from "../config/config.js";
...
const HOOK_SOURCE_POLICIES: Record<HookSource, HookSourcePolicy> = {
  "mechanical-wings-bundled": {
    precedence: 10,
    trustedLocalCode: true,
    defaultEnableMode: "default-on",
    canOverride: ["mechanical-wings-bundled"],
    canBeOverriddenBy: ["mechanical-wings-managed", "mechanical-wings-plugin"],
  },
  "mechanical-wings-plugin": {
    precedence: 20,
    trustedLocalCode: true,
    defaultEnableMode: "default-on",
    canOverride: ["mechanical-wings-bundled", "mechanical-wings-plugin"],
    canBeOverriddenBy: ["mechanical-wings-managed"],
  },
  "mechanical-wings-managed": {
    precedence: 30,
    trustedLocalCode: true,
    defaultEnableMode: "default-on",
    canOverride: ["mechanical-wings-bundled", "mechanical-wings-managed", "mechanical-wings-plugin"],
    canBeOverriddenBy: ["mechanical-wings-managed"],
  },
  "mechanical-wings-workspace": {
    ...
    canOverride: ["mechanical-wings-workspace"],
    canBeOverriddenBy: ["mechanical-wings-workspace"],
  },
};
...
export function resolveHookEnableState(params: {
  ...
  if (entry.hook.source === "mechanical-wings-plugin") {
    return { enabled: true };
  }
