...
function throwGatewayAuthResolutionError(reason: string): never {
  throw new Error(
    [
      reason,
      "Fix: set WINGS_OF_WORLD_BACKEND_GATEWAY_TOKEN/WINGS_OF_WORLD_BACKEND_GATEWAY_PASSWORD, pass --token/--password,",
      "or use legacy OPENCLAW_GATEWAY_TOKEN/OPENCLAW_GATEWAY_PASSWORD compatibility vars,",
...
function readGatewayTokenEnv(env: NodeJS.ProcessEnv): string | undefined {
  return (
    trimToUndefined(env.WINGS_OF_WORLD_BACKEND_GATEWAY_TOKEN) ??
    trimToUndefined(env.WINGS_OF_WORLD_GATEWAY_TOKEN) ??
...
function readGatewayPasswordEnv(env: NodeJS.ProcessEnv): string | undefined {
  return (
    trimToUndefined(env.WINGS_OF_WORLD_BACKEND_GATEWAY_PASSWORD) ??
    trimToUndefined(env.WINGS_OF_WORLD_GATEWAY_PASSWORD) ??
...
export class GatewayChatClient {
  ...
  constructor(connection: ResolvedGatewayConnection) {
    ...
    this.client = new GatewayClient({
      ...
      clientDisplayName: "mechanical-wings-tui",
