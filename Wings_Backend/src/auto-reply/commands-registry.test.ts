...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@mechanical-wings", { botUsername: "mechanical-wings" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@mechanical-wings args", {
        botUsername: "mechanical-wings",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@mechanical-wings: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "mechanical-wings" })).toBe(
      "/help@otherbot",
    );
  });
