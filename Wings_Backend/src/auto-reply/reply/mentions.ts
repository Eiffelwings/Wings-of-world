...
function resolveMentionPatterns(cfg: WingsConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: WingsConfig | undefined, agentId?: string): RegExp[] {
