...
function resolveAcpStreamCoalesceIdleMs(cfg: WingsConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: WingsConfig): number {
...
export function resolveAcpProjectionSettings(cfg: WingsConfig): AcpProjectionSettings {
