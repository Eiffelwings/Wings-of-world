...
function createMatrixThreadCommandParams(commandBody: string, cfg: WingsConfig = baseCfg) {
...
function createMatrixRoomCommandParams(commandBody: string, cfg: WingsConfig = baseCfg) {
  const params = buildCommandTestParams(commandBody, cfg, {
    Provider: "matrix",
    Surface: "matrix",
    OriginatingChannel: "matrix",
