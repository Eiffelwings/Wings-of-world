...
function expectLaunchctlEnableBootstrapOrder(env: Record<string, string | undefined>) {
  ...
  const label = "ai.wings-of-world.backend.gateway";
...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.wings-of-world.backend.gateway\n";
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.wings-of-world.ai/gateway");
  });
  ...
  it.each([
    {
      ...
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.wings-of-world.backend.gateway.plist",
    },
    {
      ...
      expected: "/Users/test/Library/LaunchAgents/ai.wings-of-world.backend.jbphoenix.plist",
    },
    {
    ...
    },
    {
      ...
      expected: "/Users/test/Library/LaunchAgents/ai.wings-of-world.backend.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
