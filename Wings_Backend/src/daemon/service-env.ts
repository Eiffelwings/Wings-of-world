...
export function buildServiceEnvironment(params: {
  ...
  return {
    ...
    WINGS_OF_WORLD_BACKEND_PROFILE: profile,
    WINGS_OF_WORLD_BACKEND_GATEWAY_PORT: String(port),
...
export function buildNodeServiceEnvironment(params: {
  ...
  const gatewayToken = firstNonEmptyEnv(env, [
  ...
  return {
    ...buildCommonServiceEnvironment(env, sharedEnv),
    WINGS_OF_WORLD_BACKEND_GATEWAY_TOKEN: gatewayToken,
...
function buildCommonServiceEnvironment(
  ...
  const serviceEnv: Record<string, string | undefined> = {
    ...
    WINGS_OF_WORLD_BACKEND_STATE_DIR: sharedEnv.stateDir,
    WINGS_OF_WORLD_BACKEND_CONFIG_PATH: sharedEnv.configPath,
...
function resolveSharedServiceEnvironmentFields(
  ...
  const stateDir = firstNonEmptyEnv(env, [
    "WINGS_OF_WORLD_BACKEND_STATE_DIR",
    "WINGS_OF_WORLD_STATE_DIR",
    "OPENCLAW_STATE_DIR",
  ]);
  const configPath = firstNonEmptyEnv(env, [
