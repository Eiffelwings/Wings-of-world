    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["mechanical-wings directory self --channel slack", "Show the connected account identity."],
          [
            'mechanical-wings directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["mechanical-wings directory groups list --channel discord", "List available groups/channels."],
          [
            "mechanical-wings directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.wings-of-world.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
