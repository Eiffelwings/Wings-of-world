...
vi.mock("../cli-name.js", () => ({
  resolveCliName: () => "mechanical-wings",
}));
...
describe("registerPreActionHooks", () => {
  ...
  function buildProgram() {
    const program = new Command().name("mechanical-wings");
    program
      .command("status")
      .option("--json")
      .action(() => {});
  ...
  it("handles debug mode and plugin-required command preaction", async () => {
    ...
    await runPreAction({
      parseArgv: ["status"],
      processArgv: ["node", "mechanical-wings", "status", "--debug"],
    });
    ...
    expect(processTitleSetSpy).toHaveBeenCalledWith("mechanical-wings-status");

    vi.clearAllMocks();
    await runPreAction({
      parseArgv: ["message", "send"],
      processArgv: ["node", "mechanical-wings", "message", "send"],
    });
  ...
  it("keeps setup alias and channels add manifest-first", async () => {
    await runPreAction({
      parseArgv: ["onboard"],
      processArgv: ["node", "mechanical-wings", "onboard"],
    });
    ...
    await runPreAction({
      ...
      processArgv: ["node", "mechanical-wings", "channels", "add"],
    });
  ...
  it("only allows invalid config for explicit Matrix reinstall requests", async () => {
    await runPreAction({
      parseArgv: ["plugins", "install", "@mechanical-wings/matrix"],
      processArgv: ["node", "mechanical-wings", "plugins", "install", "@mechanical-wings/matrix"],
    });
    ...
    await runPreAction({
      ...
      processArgv: ["node", "mechanical-wings", "plugins", "install", "alpha"],
    });
    ...
    await runPreAction({
      ...
      processArgv: ["node", "mechanical-wings", "plugins", "install", "./extensions/matrix"],
    });
    ...
    vi.clearAllMocks();
    await runPreAction({
      parseArgv: ["plugins", "install", "@mechanical-wings/matrix", "--marketplace", "local/repo"],
      processArgv: [
        "node",
        "mechanical-wings",
        "plugins",
        "install",
        "@mechanical-wings/matrix",
        "--marketplace",
        "local/repo",
      ],
    });
  ...
  it("skips help/version preaction and respects banner opt-out", async () => {
    await runPreAction({
      parseArgv: ["status"],
      processArgv: ["node", "mechanical-wings", "--version"],
    });
    ...
    await runPreAction({
      parseArgv: ["status"],
      processArgv: ["node", "mechanical-wings", "status"],
    });
  ...
  it("applies --json stdout suppression only for explicit JSON output commands", async () => {
    await runPreAction({
      parseArgv: ["status"],
      processArgv: ["node", "mechanical-wings", "status", "--json"],
    });
    ...
    await runPreAction({
      ...
      processArgv: ["node", "mechanical-wings", "update", "status", "--json"],
    });
    ...
    await runPreAction({
      ...
      processArgv: ["node", "mechanical-wings", "config", "set", "gateway.auth.mode", "{bad", "--json"],
    });
  ...
  it("routes logs to stderr in --json mode so stdout stays clean", async () => {
    await runPreAction({
      ...
      processArgv: ["node", "mechanical-wings", "agents", "list", "--json"],
    });
    ...
    await runPreAction({
      ...
      processArgv: ["node", "mechanical-wings", "config", "set", "gateway.auth.mode", "local", "--json"],
    });
    ...
    await runPreAction({
      parseArgv: ["agents", "list"],
      processArgv: ["node", "mechanical-wings", "agents", "list"],
    });
  ...
  it("bypasses config guard for config validate", async () => {
    await runPreAction({
      ...
      processArgv: ["node", "mechanical-wings", "config", "validate"],
    });
  ...
  it("bypasses config guard for config validate when root option values are present", async () => {
    await runPreAction({
      parseArgv: ["config", "validate"],
      processArgv: ["node", "mechanical-wings", "--profile", "work", "config", "validate"],
    });
  ...
  it("bypasses config guard for config schema", async () => {
    await runPreAction({
      ...
      processArgv: ["node", "mechanical-wings", "config", "schema"],
    });
  ...
  it("bypasses config guard for backup create", async () => {
    await runPreAction({
      ...
      processArgv: ["node", "mechanical-wings", "backup", "create", "--json"],
    });
