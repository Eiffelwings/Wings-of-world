...
${formatHelpExamples([
  ['mechanical-wings message send --target +15555550123 --message "Hi"', "Send a text message."],
  [
    'mechanical-wings message send --target +15555550123 --message "Hi" --media photo.jpg',
  ...
  [
    'mechanical-wings message react --channel discord --target 123 --message-id 456 --emoji "✅"',
    "React to a message.",
  ],
])}

${theme.muted("Docs:")} ${formatDocsLink("/cli/message", "docs.wings-of-world.ai/cli/message")}`,
    )
    .action(() => {
