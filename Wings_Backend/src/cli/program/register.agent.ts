...
${formatHelpExamples([
  ['wings-of-world-backend agent --to +15555550123 --message "status update"', "Start a new session."],
  ['wings-of-world-backend agent --agent ops --message "Summarize logs"', "Use a specific agent."],
  [
    'wings-of-world-backend agent --session-id 1234 --message "Summarize inbox" --thinking medium',
    "Target a session with explicit thinking level.",
  ],
  [
    'wings-of-world-backend agent --to +15555550123 --message "Trace logs" --verbose on --json',
    "Enable verbose logging and JSON output.",
  ],
  ['wings-of-world-backend agent --to +15555550123 --message "Summon reply" --deliver', "Deliver reply."],
  [
    'wings-of-world-backend agent --agent ops --message "Generate report" --deliver --reply-channel slack --reply-to "#reports"',
    "Send reply to a different channel/target.",
  ],
])}

${theme.muted("Docs:")} ${formatDocsLink("/cli/agent", "docs.wings-of-world.ai/cli/agent")}`,
    )
    .action(async (opts) => {
  ...
  const agents = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/agents", "docs.wings-of-world.ai/cli/agents")}\n`,
    );
...
${theme.heading("Examples:")}
${formatHelpExamples([
  ['wings-of-world-backend agents set-identity --agent main --name "Wings" --emoji "🪽"', "Set name + emoji."],
  ["wings-of-world-backend agents set-identity --agent main --avatar avatars/mechanical-wings.png", "Set avatar path."],
  [
    "wings-of-world-backend agents set-identity --workspace ~/.wings-of-world-backend/workspace --from-identity",
    "Load from IDENTITY.md.",
  ],
  [
    "wings-of-world-backend agents set-identity --identity-file ~/.wings-of-world-backend/workspace/IDENTITY.md --agent main",
