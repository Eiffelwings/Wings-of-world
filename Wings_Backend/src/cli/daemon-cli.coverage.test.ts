...
describe("daemon-cli coverage", () => {
  ...
  beforeEach(() => {
    ...
    process.env.OPENCLAW_STATE_DIR = "/tmp/mechanical-wings-cli-state";
    process.env.OPENCLAW_CONFIG_PATH = "/tmp/mechanical-wings-cli-state/mechanical-wings.json";
  ...
  it("derives probe URL from service args + env (json)", async () => {
    ...
    serviceReadCommand.mockResolvedValueOnce({
      ...
      environment: {
        ...
        OPENCLAW_STATE_DIR: "/tmp/mechanical-wings-daemon-state",
        OPENCLAW_CONFIG_PATH: "/tmp/mechanical-wings-daemon-state/mechanical-wings.json",
        OPENCLAW_GATEWAY_PORT: "19001",
      },
      sourcePath: "/tmp/ai.mechanical-wings.gateway.plist",
    });
