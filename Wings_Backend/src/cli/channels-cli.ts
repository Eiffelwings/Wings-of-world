    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["mechanical-wings channels list", "List configured channels and auth profiles."],
          ["mechanical-wings channels status --probe", "Run channel status checks and probes."],
          [
            "mechanical-wings channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["mechanical-wings channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.wings-of-world.ai/cli/channels",
        )}\n`,
    );
