...
const SANDBOX_EXAMPLES = {
  main: [
    ["mechanical-wings sandbox list", "List all sandbox containers."],
    ...
    ["mechanical-wings sandbox recreate --session main", "Recreate a specific session."],
    ["mechanical-wings sandbox recreate --agent mybot", "Recreate agent containers."],
    ["mechanical-wings sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["mechanical-wings sandbox list", "List all sandbox containers."],
    ["mechanical-wings sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["mechanical-wings sandbox recreate --all", "Recreate all containers."],
    ["mechanical-wings sandbox recreate --session main", "Recreate a specific session."],
    ["mechanical-wings sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["mechanical-wings sandbox recreate --browser --all", "Recreate only browser containers."],
    ["mechanical-wings sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["mechanical-wings sandbox explain", "Show effective sandbox config."],
    ["mechanical-wings sandbox explain --session agent:main:main", "Explain a specific session."],
    ["mechanical-wings sandbox explain --agent work", "Explain an agent sandbox."],
    ["mechanical-wings sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.wings-of-world.ai/cli/sandbox")}\n`,
    )
    .action(() => {
