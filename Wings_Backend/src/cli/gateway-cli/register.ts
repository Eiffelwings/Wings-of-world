      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["wings-of-world-backend gateway run", "Run the gateway in the foreground."],
            ["wings-of-world-backend gateway status", "Show service status and probe reachability."],
            ["wings-of-world-backend gateway discover", "Find local and wide-area gateway beacons."],
            ["wings-of-world-backend gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.wings-of-world.ai/cli/gateway")}\n`,
      ),
  );
