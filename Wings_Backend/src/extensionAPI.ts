// Legacy compat surface for plugins that still import mechanical-wings/extension-api.
...
if (shouldWarnExtensionApiImport) {
  process.emitWarning(
    "mechanical-wings/extension-api is deprecated. Migrate to api.runtime.agent.* or focused mechanical-wings/plugin-sdk/<subpath> imports. See https://docs.wings-of-world.ai/plugins/sdk-migration",
    {
      code: "OPENCLAW_EXTENSION_API_DEPRECATED",
      detail:
        "This compatibility bridge is temporary. Bundled plugins should use the injected plugin runtime instead of importing host-side agent helpers directly. Migration guide: https://docs.wings-of-world.ai/plugins/sdk-migration",
    },
  );
}
