...
export function listBindings(cfg: WingsConfig): AgentRouteBinding[] {
...
export function listBoundAccountIds(cfg: WingsConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: WingsConfig) {
