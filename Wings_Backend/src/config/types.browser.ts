export type BrowserProfileConfig = {
  ...
  userDataDir?: string;
  /** Profile driver (default: mechanical-wings). */
  driver?: "mechanical-wings" | "clawd" | "existing-session";
...
export type BrowserConfig = {
  ...
  /** Accent color for the mechanical-wings browser profile (hex). Default: #FF4500 */
  color?: string;
