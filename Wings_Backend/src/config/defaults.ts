...
function resolveAnthropicDefaultAuthMode(cfg: WingsConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: WingsConfig): WingsConfig {
...
export function applyTalkApiKey(config: WingsConfig): WingsConfig {
...
export function applyTalkConfigNormalization(config: WingsConfig): WingsConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: WingsConfig): WingsConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: WingsConfig): WingsConfig {
...
export function applyLoggingDefaults(cfg: WingsConfig): WingsConfig {
...
export function applyContextPruningDefaults(cfg: WingsConfig): WingsConfig {
...
export function applyCompactionDefaults(cfg: WingsConfig): WingsConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
