...
import type { ConfigFileSnapshot } from "./types.mechanical-wings.js";
...
describe("redactConfigSnapshot", () => {
  ...
  it("does not redact passwordFile path fields", () => {
    const snapshot = makeSnapshot({
      channels: {
        irc: {
          passwordFile: "/etc/mechanical-wings/irc-password.txt",
          nickserv: {
            passwordFile: "/etc/mechanical-wings/nickserv-password.txt",
    ...
    expect(irc.passwordFile).toBe("/etc/mechanical-wings/irc-password.txt");
    expect(nickserv.passwordFile).toBe("/etc/mechanical-wings/nickserv-password.txt");
