...
import type { ConfigFileSnapshot, WingsConfig } from "./types.js";

const mockLoadConfig = vi.hoisted(() => vi.fn<() => WingsConfig>());
...
function makeSnapshot(params: { valid: boolean; config?: WingsConfig }): ConfigFileSnapshot {
  return {
