...
if (shouldWarnCompatImport) {
  process.emitWarning(
    "mechanical-wings/plugin-sdk/compat is deprecated for new plugins. Migrate to focused mechanical-wings/plugin-sdk/<subpath> imports. See https://docs.wings-of-world.ai/plugins/sdk-migration",
    {
      code: "OPENCLAW_PLUGIN_SDK_COMPAT_DEPRECATED",
      detail:
        "Bundled plugins must use scoped plugin-sdk subpaths. External plugins may keep compat temporarily while migrating. Migration guide: https://docs.wings-of-world.ai/plugins/sdk-migration",
    },
  );
}
