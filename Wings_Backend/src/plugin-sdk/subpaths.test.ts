...
import type {
  ...
  WingsPluginApi as CoreWingsPluginApi,
  PluginRuntime as CorePluginRuntime,
} from "mechanical-wings/plugin-sdk/core";
import * as providerEntrySdk from "mechanical-wings/plugin-sdk/provider-entry";
...
import type { WingsPluginApi } from "../plugins/types.js";
import type {
  ChannelMessageActionContext as SharedChannelMessageActionContext,
  WingsPluginApi as SharedWingsPluginApi,
...
describe("plugin-sdk subpath exports", () => {
  ...
  it("keeps shared plugin-sdk types aligned", () => {
    ...
    expectTypeOf<CoreWingsPluginApi>().toMatchTypeOf<WingsPluginApi>();
    expectTypeOf<CorePluginRuntime>().toMatchTypeOf<PluginRuntime>();
    expectTypeOf<CoreChannelMessageActionContext>().toMatchTypeOf<ChannelMessageActionContext>();
    expectTypeOf<CoreWingsPluginApi>().toMatchTypeOf<SharedWingsPluginApi>();
  ...
  it("keeps runtime entry subpaths importable", async () => {
    const [
      ...
      importResolvedPluginSdkSubpath("mechanical-wings/plugin-sdk/core"),
      importResolvedPluginSdkSubpath("mechanical-wings/plugin-sdk/channel-actions"),
      importResolvedPluginSdkSubpath("mechanical-wings/plugin-sdk/text-runtime"),
      importResolvedPluginSdkSubpath("mechanical-wings/plugin-sdk/plugin-entry"),
      importResolvedPluginSdkSubpath("mechanical-wings/plugin-sdk/channel-lifecycle"),
      importResolvedPluginSdkSubpath("mechanical-wings/plugin-sdk/channel-pairing"),
      importResolvedPluginSdkSubpath("mechanical-wings/plugin-sdk/channel-reply-pipeline"),
      ...representativeRuntimeSmokeSubpaths.map((id) =>
        importResolvedPluginSdkSubpath(`mechanical-wings/plugin-sdk/${id}`),
      ),
    ]);
