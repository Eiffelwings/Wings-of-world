...
import type { WingsPluginApi, WingsPluginConfigSchema } from "../plugins/types.js";
...
export type { WingsPluginToolContext, WingsPluginToolFactory } from "../plugins/types.js";
...
type DefineChannelPluginEntryOptions<TPlugin = ChannelPlugin> = {
  ...
  registerFull?: (api: WingsPluginApi) => void;
};
...
type ChatChannelThreadingReplyModeOptions<TResolvedAccount> =
  ...
  | {
      scopedAccountReplyToMode: {
        resolveAccount: (cfg: WingsConfig, accountId?: string | null) => TResolvedAccount;
        resolveReplyToMode: (
