...
function resolveDefaultLocalPathRoots(): readonly string[] {
  return mergeInboundPathRoots(getDefaultMediaLocalRoots(), DEFAULT_IMESSAGE_ATTACHMENT_ROOTS);
}
...
export class MediaAttachmentCache {
  ...
  constructor(attachments: MediaAttachment[], options?: MediaAttachmentCacheOptions) {
    ...
    this.localPathRoots = mergeInboundPathRoots(options?.localPathRoots, resolveDefaultLocalPathRoots());
