  ...
  it.each([
    {
      ...
      homedir: () => "/fallback",
      expected: "/srv/mechanical-wings-home",
    },
    {
  ...
  it.each([
    {
      ...
      input: "~/x",
      opts: {
        env: { OPENCLAW_HOME: "/srv/mechanical-wings-home" } as NodeJS.ProcessEnv,
      },
      expected: `${path.resolve("/srv/mechanical-wings-home")}/x`,
    },
    {
      name: "expands exact ~ using explicit home",
      input: "~",
      opts: { home: " /srv/mechanical-wings-home " },
      expected: "/srv/mechanical-wings-home",
    },
    {
...
describe("resolveHomeRelativePath", () => {
  ...
  it("expands tilde paths using the resolved home directory", () => {
    ...
    ).toBe(path.resolve("/srv/mechanical-wings-home/docs"));
  });
