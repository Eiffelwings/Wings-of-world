...
const CORE_PACKAGE_NAMES = new Set(["mechanical-wings", "wings-of-world-backend"]);
...
export async function resolveWingsPackageRoot(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): Promise<string | null> {
...
export function resolveWingsPackageRootSync(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): string | null {
