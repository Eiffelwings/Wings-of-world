...
const PRIMARY_PACKAGE_NAME = "mechanical-wings";
const ALL_PACKAGE_NAMES = [PRIMARY_PACKAGE_NAME] as const;
const GLOBAL_RENAME_PREFIX = ".";
export const OPENCLAW_MAIN_PACKAGE_SPEC = "github:mechanical-wings/mechanical-wings#main";
...
async function resolvePortableGitPathPrepend(
  ...
  const portableGitRoot = path.join(localAppData, "Wings", "deps", "portable-git");
  const candidates = [
