...
const GATEWAY_DEVICE_ID_HEADER = "x-mechanical-wings-gateway-device-id";
const GATEWAY_SIGNATURE_HEADER = "x-mechanical-wings-gateway-signature";
const GATEWAY_SIGNED_AT_HEADER = "x-mechanical-wings-gateway-signed-at-ms";
...
function buildRelayGatewaySignaturePayload(params: {
  ...
  return [
    "mechanical-wings-relay-send-v1",
