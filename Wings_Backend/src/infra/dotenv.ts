...
export function loadDotEnv(opts?: { quiet?: boolean }) {
  ...
  // Then load global fallback:
  // ~/.wings-of-world-backend/.env (or WINGS_OF_WORLD_BACKEND_STATE_DIR/.env).
  // Legacy OPENCLAW_STATE_DIR remains supported and is not overridden.
