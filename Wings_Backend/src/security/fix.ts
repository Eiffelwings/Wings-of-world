...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof WingsConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: WingsConfig; env: NodeJS.ProcessEnv }): {
  cfg: WingsConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
