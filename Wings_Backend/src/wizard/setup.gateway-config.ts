...
import type { GatewayBindMode, GatewayTailscaleMode, WingsConfig } from "../config/config.js";
  ...
  if (authMode === "token") {
    ...
    if (tokenMode === "ref") {
      ...
      gatewayToken =
        ...
        normalizeGatewayTokenInput(process.env.WINGS_OF_WORLD_BACKEND_GATEWAY_TOKEN) ||
        normalizeGatewayTokenInput(process.env.WINGS_OF_WORLD_GATEWAY_TOKEN) ||
