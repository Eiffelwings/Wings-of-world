...
function resolveGatewayTokenFromEnv(env: NodeJS.ProcessEnv): string | undefined {
  return (
    env.WINGS_OF_WORLD_BACKEND_GATEWAY_TOKEN?.trim() ||
    env.WINGS_OF_WORLD_GATEWAY_TOKEN?.trim() ||
...
function resolveGatewayPasswordFromEnv(env: NodeJS.ProcessEnv): string | undefined {
  return (
    env.WINGS_OF_WORLD_BACKEND_GATEWAY_PASSWORD?.trim() ||
    env.WINGS_OF_WORLD_GATEWAY_PASSWORD?.trim() ||
