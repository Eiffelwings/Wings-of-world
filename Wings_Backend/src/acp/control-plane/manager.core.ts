...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: WingsConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: WingsConfig): AcpManagerObservabilitySnapshot {
  ...
  private resolveTurnTimeoutMs(params: { cfg: WingsConfig; meta: SessionAcpMeta }): number {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: WingsConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: WingsConfig }): Promise<void> {
