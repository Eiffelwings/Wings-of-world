...
export function isAcpEnabledByPolicy(cfg: WingsConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: WingsConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: WingsConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: WingsConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: WingsConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: WingsConfig, agentId: string): boolean {
