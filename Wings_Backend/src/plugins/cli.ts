...
import { loadWingsPlugins, type PluginLoadOptions } from "./loader.js";
import type { WingsPluginCliCommandDescriptor } from "./types.js";
...
export function getPluginCliCommandDescriptors(
  ...
  try {
    ...
    const descriptors: WingsPluginCliCommandDescriptor[] = [];
