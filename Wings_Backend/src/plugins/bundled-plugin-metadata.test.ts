...
describe("bundled plugin metadata", () => {
  ...
  it("prefers built generated paths when present and falls back to source paths", () => {
    const tempRoot = createGeneratedPluginTempRoot("mechanical-wings-bundled-plugin-metadata-");
  ...
  it("supports check mode for stale generated artifacts", async () => {
    const tempRoot = createGeneratedPluginTempRoot("mechanical-wings-bundled-plugin-generated-");

    writeJson(path.join(tempRoot, "extensions", "alpha", "package.json"), {
      name: "@mechanical-wings/alpha",
      version: "0.0.1",
      "mechanical-wings": {
        extensions: ["./index.ts"],
      },
    });
    writeJson(path.join(tempRoot, "extensions", "alpha", "mechanical-wings.plugin.json"), {
      id: "alpha",
  ...
  it("merges generated channel schema metadata with manifest-owned channel config fields", async () => {
    const tempRoot = createGeneratedPluginTempRoot("mechanical-wings-bundled-plugin-channel-configs-");
  ...
  it("captures top-level public surface artifacts without duplicating the primary entrypoints", async () => {
    const tempRoot = createGeneratedPluginTempRoot("mechanical-wings-bundled-plugin-public-artifacts-");
