...
export type ProviderOnboardPresetAppliers<TArgs extends unknown[]> = {
  applyProviderConfig: (cfg: WingsConfig, ...args: TArgs) => WingsConfig;
  applyConfig: (cfg: WingsConfig, ...args: TArgs) => WingsConfig;
};
...
>(params: {
  ...
  applyPreset: (cfg: WingsConfig, preset: TParams) => WingsConfig;
  primaryModelRef: string;
