...
import type { PluginConfigUiHint, WingsPluginConfigSchema } from "./types.js";
...
type BuildPluginConfigSchemaOptions = {
  ...
  safeParse?: WingsPluginConfigSchema["safeParse"];
};
...
export function emptyPluginConfigSchema(): WingsPluginConfigSchema {
  return {
