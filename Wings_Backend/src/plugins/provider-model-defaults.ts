...
export function applyGoogleGeminiModelDefault(cfg: WingsConfig): {
  next: WingsConfig;
  changed: boolean;
} {
...
export function applyOpenAIProviderConfig(cfg: WingsConfig): WingsConfig {
...
export function applyOpenAIConfig(cfg: WingsConfig): WingsConfig {
...
export function applyOpencodeGoModelDefault(cfg: WingsConfig): {
  next: WingsConfig;
  changed: boolean;
} {
...
export function applyOpencodeZenModelDefault(cfg: WingsConfig): {
  next: WingsConfig;
  changed: boolean;
} {
