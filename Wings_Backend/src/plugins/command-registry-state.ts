...
import type { WingsPluginCommandDefinition } from "./types.js";

export type RegisteredPluginCommand = WingsPluginCommandDefinition & {
  pluginId: string;
  pluginName?: string;
  pluginRoot?: string;
};
...
const PLUGIN_COMMAND_STATE_KEY = Symbol.for("mechanical-wings.pluginCommandsState");
