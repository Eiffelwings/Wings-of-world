...
export const PLUGIN_MANIFEST_FILENAME = "wings-of-world.plugin.json";
...
// package.json "mechanical-wings" metadata (used for setup/catalog)
...
export type WingsPackageStartup = {
  /**
...
export type WingsPackageManifest = {
  extensions?: string[];
  setupEntry?: string;
  channel?: PluginPackageChannel;
  install?: PluginPackageInstall;
  startup?: WingsPackageStartup;
};
...
): WingsPackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }
