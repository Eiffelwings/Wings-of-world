...
type LoginOpenAICodexOAuth =
  (typeof import("mechanical-wings/plugin-sdk/provider-auth-login"))["loginOpenAICodexOAuth"];
type GithubCopilotLoginCommand =
  (typeof import("mechanical-wings/plugin-sdk/provider-auth-login"))["githubCopilotLoginCommand"];
type CreateVpsAwareHandlers =
  (typeof import("../provider-oauth-flow.js"))["createVpsAwareOAuthHandlers"];
type EnsureAuthProfileStore =
  typeof import("mechanical-wings/plugin-sdk/agent-runtime").ensureAuthProfileStore;
type ListProfilesForProvider =
  typeof import("mechanical-wings/plugin-sdk/agent-runtime").listProfilesForProvider;
...
vi.mock("mechanical-wings/plugin-sdk/provider-auth-login", async (importOriginal) => {
  const actual = await importOriginal<typeof import("mechanical-wings/plugin-sdk/provider-auth-login")>();
  return {
    ...actual,
...
vi.mock("mechanical-wings/plugin-sdk/agent-runtime", async (importOriginal) => {
