...
describe("provider discovery contract", () => {
  beforeEach(async () => {
    vi.resetModules();
    vi.doMock("mechanical-wings/plugin-sdk/agent-runtime", async () => {
    ...
    vi.doMock("mechanical-wings/plugin-sdk/provider-auth", async () => {
      const actual = await vi.importActual<object>("mechanical-wings/plugin-sdk/provider-auth");
      return {
        ...actual,
        ensureAuthProfileStore: ensureAuthProfileStoreMock,
        listProfilesForProvider: listProfilesForProviderMock,
    ...
    vi.doMock("mechanical-wings/plugin-sdk/provider-setup", async () => {
      const actual = await vi.importActual<object>("mechanical-wings/plugin-sdk/provider-setup");
      return {
        ...actual,
    ...
    vi.doMock("mechanical-wings/plugin-sdk/self-hosted-provider-setup", async () => {
      const actual = await vi.importActual<object>(
        "mechanical-wings/plugin-sdk/self-hosted-provider-setup",
      );
      return {
        ...actual,
        buildVllmProvider: (...args: unknown[]) => buildVllmProviderMock(...args),
