...
export function applyProviderDefaultModel(cfg: WingsConfig, modelRef: string): WingsConfig {
...
function buildOpenAICompatibleSelfHostedProviderConfig(params: {
  ...
  maxTokens?: number;
}): { config: WingsConfig; modelId: string; modelRef: string; profileId: string } {
