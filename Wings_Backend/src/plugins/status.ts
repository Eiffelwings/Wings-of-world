...
import { normalizeWingsVersionBase } from "../config/version.js";
...
function resolveReportedPluginVersion(
  ...
  return (
    normalizeWingsVersionBase(resolveCompatibilityHostVersion(env)) ??
    normalizeWingsVersionBase(plugin.version) ??
    plugin.version
  );
}
