...
export const A2UI_PATH = "/__wings-of-world__/a2ui";
export const LEGACY_A2UI_PATH = "/__mechanical-wings__/a2ui";
const A2UI_PATHS = [A2UI_PATH, LEGACY_A2UI_PATH] as const;

export const CANVAS_HOST_PATH = "/__wings-of-world__/canvas";

export const CANVAS_WS_PATH = "/__wings-of-world__/ws";
export const LEGACY_CANVAS_WS_PATH = "/__mechanical-wings__/ws";
...
function resolveA2uiBasePath(pathname: string): string | undefined {
  return A2UI_PATHS.find((basePath) => pathname === basePath || pathname.startsWith(`${basePath}/`));
}
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.mechanicalWingsCanvasA2UIAction.postMessage(...)
  // - Android: window.mechanicalWingsCanvasA2UIAction.postMessage(...)
  const handlerNames = ["mechanicalWingsCanvasA2UIAction"];
  ...
  globalThis.Wings.postMessage = postToNode;
  globalThis.Wings.sendUserAction = sendUserAction;
  globalThis.mechanicalWingsPostMessage = postToNode;
  globalThis.mechanicalWingsSendUserAction = sendUserAction;
