...
function resolveSpeechProviderPluginEntries(cfg?: WingsConfig): SpeechProviderPlugin[] {
...
function buildProviderMaps(cfg?: WingsConfig): {
...
export function listSpeechProviders(cfg?: WingsConfig): SpeechProviderPlugin[] {
