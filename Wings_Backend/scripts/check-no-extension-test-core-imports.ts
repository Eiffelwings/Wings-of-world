...
const FORBIDDEN_PATTERNS: Array<{ pattern: RegExp; hint: string }> = [
  {
    pattern: /["']mechanical-wings\/plugin-sdk["']/,
    hint: "Use mechanical-wings/plugin-sdk/<subpath> instead of the monolithic root entry.",
  },
  {
    pattern: /["']mechanical-wings\/plugin-sdk\/test-utils["']/,
    hint: "Use mechanical-wings/plugin-sdk/testing for the public extension test surface.",
  },
  {
    pattern: /["']mechanical-wings\/plugin-sdk\/compat["']/,
  ...
  },
  {
    ...
    hint: "Use test/helpers/extensions/* for repo-only helpers, or mechanical-wings/plugin-sdk/testing for public surfaces.",
  },
  {
