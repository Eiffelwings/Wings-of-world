...
if [[ -z "$version_content" ]]; then
  echo "<h2>Wings🪽 $VERSION</h2>"
  echo "<p>Latest Wings🪽 update.</p>"
  echo "<p><a href=\"https://github.com/mechanical-wings/mechanical-wings/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
