...
SMOKE_IMAGE="${OPENCLAW_INSTALL_SMOKE_IMAGE:-mechanical-wings-install-smoke:local}"
NONROOT_IMAGE="${OPENCLAW_INSTALL_NONROOT_IMAGE:-mechanical-wings-install-nonroot:local}"
INSTALL_URL="${OPENCLAW_INSTALL_URL:-https://mechanical-wings.bot/install.sh}"
CLI_INSTALL_URL="${OPENCLAW_INSTALL_CLI_URL:-https://mechanical-wings.bot/install-cli.sh}"
