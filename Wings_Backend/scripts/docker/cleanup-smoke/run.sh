...
export OPENCLAW_STATE_DIR="/tmp/mechanical-wings-test"
...
pnpm mechanical-wings reset --scope config+creds+sessions --yes --non-interactive
...
pnpm mechanical-wings uninstall --state --yes --non-interactive
