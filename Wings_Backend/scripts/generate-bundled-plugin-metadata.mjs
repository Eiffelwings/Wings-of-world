...
const MANIFEST_KEY = "mechanical-wings";
...
function resolvePackageChannelMeta(packageJson) {
  const mechanicalWingsMeta =
    ...
    "mechanical-wings" in packageJson
      ? packageJson["mechanical-wings"]
      : undefined;
  if (!mechanicalWingsMeta || typeof mechanicalWingsMeta !== "object" || Array.isArray(mechanicalWingsMeta)) {
    return undefined;
  }
  const channelMeta = mechanicalWingsMeta.channel;
