...
show_usage() {
    cat << EOF
clawlog - Wings🪽 Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View Wings🪽 logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    Wings🪽 logs flow through the macOS unified log (subsystem: ai.mechanical-wings).
