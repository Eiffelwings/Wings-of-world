...
- regenerates apps/ios/Wings🪽.xcodeproj via xcodegen
EOF
}
...
OPENCLAW_APP_BUNDLE_ID = ai.mechanical-wings.client
OPENCLAW_SHARE_BUNDLE_ID = ai.mechanical-wings.client.share
OPENCLAW_ACTIVITY_WIDGET_BUNDLE_ID = ai.mechanical-wings.client.activitywidget
OPENCLAW_WATCH_APP_BUNDLE_ID = ai.mechanical-wings.client.watchkitapp
OPENCLAW_WATCH_EXTENSION_BUNDLE_ID = ai.mechanical-wings.client.watchkitapp.extension
