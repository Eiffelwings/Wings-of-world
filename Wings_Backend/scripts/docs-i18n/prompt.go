...
- Keep product names in English: Wings🪽, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the Wings🪽 Gateway, use “Gateway 网关”.
