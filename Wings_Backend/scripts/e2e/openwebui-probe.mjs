...
const targetModel =
  modelIds.find((id) => id === "mechanical-wings/default") ?? modelIds.find((id) => id === "mechanical-wings");
if (!targetModel) {
  throw new Error(`mechanical-wings model missing from Open WebUI model list: ${JSON.stringify(modelIds)}`);
}
