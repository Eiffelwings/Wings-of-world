...
IMAGE_NAME="mechanical-wings-openwebui-e2e"
...
NET_NAME="mechanical-wings-openwebui-e2e-$$"
GW_NAME="mechanical-wings-openwebui-gateway-$$"
OW_NAME="mechanical-wings-openwebui-$$"
...
docker run -d \
  ...
  --network "$NET_NAME" \
  -e ENV=prod \
  -e WEBUI_NAME="Wings🪽 E2E" \
  -e WEBUI_SECRET_KEY="mechanical-wings-openwebui-e2e-secret" \
  -e OFFLINE_MODE=True \
  ...
  -e WEBUI_ADMIN_NAME="Wings🪽 E2E" \
  -e ENABLE_SIGNUP=False \
  -e DEFAULT_MODELS="mechanical-wings/default" \
...
echo "Running Open WebUI -> Wings🪽 smoke..."
docker exec \
