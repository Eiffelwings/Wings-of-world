...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.mechanical-wings", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Wings🪽 windows, but below the system’s pop-up menus.
