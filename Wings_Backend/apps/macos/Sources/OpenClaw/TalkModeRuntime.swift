...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.mechanical-wings", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.mechanical-wings", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [Wings🪽ChatMessage] = messages.compactMap { item in
