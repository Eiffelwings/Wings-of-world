...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.mechanical-wings", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        Wings🪽Paths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        Wings🪽Paths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
