...
extension ProcessInfo {
    ...
    /// Nix deployments may write defaults into a stable suite (`ai.mechanical-wings.mac`) even if the shipped
        ...
        isAppBundle: Bool) -> Bool
    {
        ...
        if standard.bool(forKey: "mechanical-wings.nixMode") { return true }
        ...
        if isAppBundle, let stableSuite, stableSuite.bool(forKey: "mechanical-wings.nixMode") { return true }
