...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.mechanical-wings", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return Wings🪽ConfigFile.defaultWorkspaceURL() }
    ...
    static func defaultBootstrapTemplate() -> String {
        ...
        3) ~/.mechanical-wings/mechanical-wings.json
