...
enum Wings🪽ConfigFile {
    private static let logger = Logger(subsystem: "ai.mechanical-wings", category: "config")
    ...
    static func stateDirURL() -> URL {
        Wings🪽Paths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        Wings🪽Paths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-mechanical-wings-config-file",
            "event": "config.write",
