...
enum LaunchAgentManager {
    private static var plistURL: URL {
        FileManager().homeDirectoryForCurrentUser
            .appendingPathComponent("Library/LaunchAgents/ai.mechanical-wings.mac.plist")
    }
    ...
    static func plistContents(bundlePath: String) -> String {
        ...
        <dict>
          <key>Label</key>
          <string>ai.mechanical-wings.mac</string>
          <key>ProgramArguments</key>
          <array>
            <string>\(bundlePath)/Contents/MacOS/Wings🪽</string>
          </array>
