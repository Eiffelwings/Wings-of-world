...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .mechanical-wingsSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? Wings🪽Paths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? Wings🪽Paths.stateDirURL.path
...
extension Notification.Name {
    static let mechanical-wingsSelectSettingsTab = Notification.Name("mechanical-wingsSelectSettingsTab")
}
