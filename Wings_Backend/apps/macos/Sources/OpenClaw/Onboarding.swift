...
enum UIStrings {
    static let welcomeTitle = "Welcome to Wings🪽"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "mechanical-wings.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: Wings🪽ChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g mechanical-wings@\(version)"
    }
