...
private let onboardingWizardLogger = Logger(subsystem: "ai.mechanical-wings", category: "onboarding.wizard")

// MARK: - Swift 6 AnyCodable Bridging Helpers

// Bridge between Wings🪽Protocol.AnyCodable and the local module to avoid
// Swift 6 strict concurrency type conflicts.

private typealias ProtocolAnyCodable = Wings🪽Protocol.AnyCodable
