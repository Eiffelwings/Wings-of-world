...
final class CLIInstallPrompter {
    ...
    private let logger = Logger(subsystem: "ai.mechanical-wings", category: "cli.prompt")
    ...
    func checkAndPromptIfNeeded(reason: String) {
        ...
        let alert = NSAlert()
        alert.messageText = "Install Wings🪽 CLI?"
    ...
    private func openSettings(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .mechanical-wingsSelectSettingsTab, object: tab)
        }
    }
