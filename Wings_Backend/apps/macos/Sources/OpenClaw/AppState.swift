...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = Wings🪽ConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = Wings🪽ConfigFile.url()
    ...
    func syncGatewayConfigNow() {
        ...
        let synced = Self.syncedGatewayRoot(
            currentRoot: Wings🪽ConfigFile.loadDict(),
        ...
        Wings🪽ConfigFile.saveDict(synced.root)
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/mechanical-wings"
        state.remoteCliPath = ""
        return state
    }
}
