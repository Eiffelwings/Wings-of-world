...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/mechanical-wings/mechanical-wings") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/mechanical-wings/mechanical-wings")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://mechanical-wings.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "Wings🪽BuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "Wings🪽BuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "Wings🪽GitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "Wings🪽GitCommit") as? String) ??
            "unknown"
    }
