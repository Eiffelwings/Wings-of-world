...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.mechanical-wings", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".mechanical-wings/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.mechanical-wingsCommand(
            subcommand: "gateway",
