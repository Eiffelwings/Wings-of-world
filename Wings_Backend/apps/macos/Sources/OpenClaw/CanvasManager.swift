...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.mechanical-wings", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Wings🪽/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__mechanical-wings__/a2ui/").absoluteString + "?platform=macos"
    }
