...
ASC_KEYCHAIN_SERVICE=mechanical-wings-asc-key
...
```bash
ASC_APP_IDENTIFIER=ai.mechanical-wings.client
# or
...
- The beta flow regenerates `apps/ios/Wings🪽.xcodeproj` from `apps/ios/project.yml` before archiving
