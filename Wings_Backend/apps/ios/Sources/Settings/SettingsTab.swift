...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = Wings🪽LocationMode.off.rawValue
    ...
    @State private var lastLocationModeRaw: String = Wings🪽LocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.mechanical-wings.ios", category: "GatewaySettings")
    ...
    var body: some View {
        NavigationStack {
                ...
                Section {
                    DisclosureGroup(isExpanded: self.$gatewayExpanded) {
                        if !self.isGatewayConnected {
                            Text(
                                "1. Open a chat with your Wings🪽 agent and send /pair\n"
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        self.featureToggle(
                            ...
                            help: "Enables voice conversation mode with your connected Wings🪽 agent.") { newValue in
                        ...
                        HStack(spacing: 8) {
                            ...
                            Button {
                                self.activeFeatureHelp = FeatureHelp(
                                    ...
                                    message: "Controls location permissions for Wings🪽. "
                        ...
                        Picker("Location Access", selection: self.$locationEnabledModeRaw) {
                            Text("Off").tag(Wings🪽LocationMode.off.rawValue)
                            Text("While Using").tag(Wings🪽LocationMode.whileUsing.rawValue)
                            Text("Always").tag(Wings🪽LocationMode.always.rawValue)
                        }
                        .labelsHidden()
                        ...
                        self.featureToggle(
                            ...
                            help: "Keeps the screen awake while Wings🪽 is open.")
                    ...
                    DisclosureGroup("Device Info") {
                        ...
                        LabeledContent("Wings🪽", value: DeviceInfoHelper.openClawVersionString())
                    }
                }
            }
            ...
            .onChange(of: self.locationEnabledModeRaw) { _, newValue in
                ...
                guard let mode = Wings🪽LocationMode(rawValue: newValue) else { return }
                Task {
    ...
    private func friendlyGatewayMessage(from raw: String) -> String? {
        ...
        if lower.contains("pairing required") {
            return "Pairing required. Go back to your Wings🪽 chat and run /pair approve, then tap Connect again."
        }
