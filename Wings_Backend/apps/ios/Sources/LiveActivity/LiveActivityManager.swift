...
final class LiveActivityManager {
    ...
    private let logger = Logger(subsystem: "ai.mechanical-wings.ios", category: "LiveActivity")
    private var currentActivity: Activity<Wings🪽ActivityAttributes>?
    ...
    func startActivity(agentName: String, sessionKey: String) {
        ...
        let attributes = Wings🪽ActivityAttributes(agentName: agentName, sessionKey: sessionKey)
    ...
    private func hydrateCurrentAndPruneDuplicates() {
        let active = Activity<Wings🪽ActivityAttributes>.activities
    ...
    private func updateCurrent(state: Wings🪽ActivityAttributes.ContentState) {
    ...
    private func connectingState() -> Wings🪽ActivityAttributes.ContentState {
        Wings🪽ActivityAttributes.ContentState(
    ...
    private func idleState() -> Wings🪽ActivityAttributes.ContentState {
        Wings🪽ActivityAttributes.ContentState(
            statusText: "Idle",
            isIdle: true,
            isDisconnected: false,
    ...
    private func disconnectedState() -> Wings🪽ActivityAttributes.ContentState {
        Wings🪽ActivityAttributes.ContentState(
