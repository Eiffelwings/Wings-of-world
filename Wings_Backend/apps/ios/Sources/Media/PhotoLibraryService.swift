...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: Wings🪽PhotosLatestParams) async throws -> Wings🪽PhotosLatestPayload {
        ...
        var results: [Wings🪽PhotoPayload] = []
        ...
        return Wings🪽PhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> Wings🪽PhotoPayload
    {
