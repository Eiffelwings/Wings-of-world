...
/// Handles navigation policy to intercept mechanical-wings:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept mechanical-wings:// deep links.
        if url.scheme?.lowercased() == "mechanical-wings" {
