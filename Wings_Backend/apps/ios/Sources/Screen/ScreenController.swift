...
final class ScreenController {
    ...
    /// Callback invoked when an mechanical-wings:// deep link is tapped in the canvas
    ...
    func applyHomeCanvasStateIfNeeded() {
        ...
        (() => {
          try {
            const api = globalThis.__mechanical-wings;
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = Wings🪽KitResources.bundle
