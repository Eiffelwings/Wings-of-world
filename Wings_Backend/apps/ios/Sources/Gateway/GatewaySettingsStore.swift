...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.mechanical-wings.gateway"
    private static let nodeService = "ai.mechanical-wings.node"
    private static let talkService = "ai.mechanical-wings.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.mechanical-wings.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.mechanical-wings.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first?
            .appendingPathComponent("mechanical-wings-gateway.log")
    }
