...
final class GatewayConnectionController {
    ...
    private func currentCaps() -> [String] {
        var caps = [Wings🪽Capability.canvas.rawValue, Wings🪽Capability.screen.rawValue]
        ...
        if cameraEnabled { caps.append(Wings🪽Capability.camera.rawValue) }

        let voiceWakeEnabled = UserDefaults.standard.bool(forKey: VoiceWakePreferences.enabledKey)
        if voiceWakeEnabled { caps.append(Wings🪽Capability.voiceWake.rawValue) }

        let locationModeRaw = UserDefaults.standard.string(forKey: "location.enabledMode") ?? "off"
        let locationMode = Wings🪽LocationMode(rawValue: locationModeRaw) ?? .off
        if locationMode != .off { caps.append(Wings🪽Capability.location.rawValue) }

        caps.append(Wings🪽Capability.device.rawValue)
        if WatchMessagingService.isSupportedOnDevice() {
            caps.append(Wings🪽Capability.watch.rawValue)
        }
        caps.append(Wings🪽Capability.photos.rawValue)
        caps.append(Wings🪽Capability.contacts.rawValue)
        caps.append(Wings🪽Capability.calendar.rawValue)
        caps.append(Wings🪽Capability.reminders.rawValue)
        if Self.motionAvailable() {
            caps.append(Wings🪽Capability.motion.rawValue)
        }
    ...
    private func currentCommands() -> [String] {
        var commands: [String] = [
            ...
            Wings🪽ScreenCommand.record.rawValue,
            Wings🪽SystemCommand.notify.rawValue,
            Wings🪽ChatCommand.push.rawValue,
        ...
        if caps.contains(Wings🪽Capability.camera.rawValue) {
        ...
        if caps.contains(Wings🪽Capability.location.rawValue) {
            commands.append(Wings🪽LocationCommand.get.rawValue)
        }
        if caps.contains(Wings🪽Capability.device.rawValue) {
            commands.append(Wings🪽DeviceCommand.status.rawValue)
            commands.append(Wings🪽DeviceCommand.info.rawValue)
        }
        if caps.contains(Wings🪽Capability.watch.rawValue) {
            commands.append(Wings🪽WatchCommand.status.rawValue)
            commands.append(Wings🪽WatchCommand.notify.rawValue)
        }
        if caps.contains(Wings🪽Capability.photos.rawValue) {
            commands.append(Wings🪽PhotosCommand.latest.rawValue)
        }
        if caps.contains(Wings🪽Capability.contacts.rawValue) {
            commands.append(Wings🪽ContactsCommand.search.rawValue)
            commands.append(Wings🪽ContactsCommand.add.rawValue)
        }
        if caps.contains(Wings🪽Capability.calendar.rawValue) {
            commands.append(Wings🪽CalendarCommand.events.rawValue)
            commands.append(Wings🪽CalendarCommand.add.rawValue)
        }
        if caps.contains(Wings🪽Capability.reminders.rawValue) {
            commands.append(Wings🪽RemindersCommand.list.rawValue)
            commands.append(Wings🪽RemindersCommand.add.rawValue)
        }
        if caps.contains(Wings🪽Capability.motion.rawValue) {
            commands.append(Wings🪽MotionCommand.activity.rawValue)
            commands.append(Wings🪽MotionCommand.pedometer.rawValue)
        }
