...
public enum Wings🪽CanvasA2UICommand: String, Codable, Sendable {
...
public struct Wings🪽CanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct Wings🪽CanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
