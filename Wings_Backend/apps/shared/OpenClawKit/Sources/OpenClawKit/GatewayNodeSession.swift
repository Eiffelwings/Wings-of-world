...
private func replaceCanvasCapabilityInScopedHostUrl(scopedUrl: String, capability: String) -> String? {
    let marker = "/__mechanical-wings__/cap/"
...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.mechanical-wings", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.mechanical-wings", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: Wings🪽Protocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
