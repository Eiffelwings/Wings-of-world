...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: Wings🪽Protocol.AnyCodable]?
    {
        ...
        return [
            "id": Wings🪽Protocol.AnyCodable(identity.deviceId),
            "publicKey": Wings🪽Protocol.AnyCodable(publicKey),
            "signature": Wings🪽Protocol.AnyCodable(signature),
            "signedAt": Wings🪽Protocol.AnyCodable(signedAtMs),
            "nonce": Wings🪽Protocol.AnyCodable(nonce),
        ]
    }
}
