...
public enum Wings🪽TalkCommand: String, Codable, Sendable {
...
public struct Wings🪽TalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct Wings🪽TalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
