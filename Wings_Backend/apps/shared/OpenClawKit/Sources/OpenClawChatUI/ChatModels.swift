...
public typealias Wings🪽PlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias Wings🪽PlatformImage = UIImage
#endif

public struct Wings🪽ChatUsageCost: Codable, Hashable, Sendable {
...
public struct Wings🪽ChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: Wings🪽ChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(Wings🪽ChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct Wings🪽ChatMessageContent: Codable, Hashable, Sendable {
...
public struct Wings🪽ChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [Wings🪽ChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: Wings🪽ChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [Wings🪽ChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: Wings🪽ChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(Wings🪽ChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([Wings🪽ChatMessageContent].self, forKey: .content) {
...
public struct Wings🪽ChatHistoryPayload: Codable, Sendable {
...
public struct Wings🪽SessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct Wings🪽SessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [Wings🪽SessionPreviewItem]
}

public struct Wings🪽SessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [Wings🪽SessionPreviewEntry]

    public init(ts: Int, previews: [Wings🪽SessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct Wings🪽ChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct Wings🪽ChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct Wings🪽AgentEventPayload: Codable, Sendable, Identifiable {
...
public struct Wings🪽ChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct Wings🪽GatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct Wings🪽PendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: Wings🪽PlatformImage?
...
public struct Wings🪽ChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
