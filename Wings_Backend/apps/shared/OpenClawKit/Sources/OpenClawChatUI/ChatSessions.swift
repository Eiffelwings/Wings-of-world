...
public struct Wings🪽ChatModelChoice: Identifiable, Codable, Sendable, Hashable {
...
public struct Wings🪽ChatSessionsDefaults: Codable, Sendable {
...
public struct Wings🪽ChatSessionEntry: Codable, Identifiable, Sendable, Hashable {
...
public struct Wings🪽ChatSessionsListResponse: Codable, Sendable {
    public let ts: Double?
    public let path: String?
    public let count: Int?
    public let defaults: Wings🪽ChatSessionsDefaults?
    public let sessions: [Wings🪽ChatSessionEntry]
    ...
    public init(
        ...
        sessions: [Wings🪽ChatSessionEntry])
    {
        self.ts = ts
        self.path = path
        self.count = count
