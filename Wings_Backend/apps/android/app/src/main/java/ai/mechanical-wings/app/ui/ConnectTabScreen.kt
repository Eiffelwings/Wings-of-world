    ...
    if (showDiagnostics) {
      Surface(
        ...
        Column(
          ...
          Text("Wings🪽 Android ${openClawAndroidVersionLabel()}", style = mobileCaption1, color = mobileTextSecondary)
          Button(
            onClick = {
    ...
    AnimatedVisibility(visible = advancedOpen) {
      Surface(
        ...
        Column(
          ...
          CommandBlock("mechanical-wings qr --setup-code-only")
          CommandBlock("mechanical-wings qr --json")
