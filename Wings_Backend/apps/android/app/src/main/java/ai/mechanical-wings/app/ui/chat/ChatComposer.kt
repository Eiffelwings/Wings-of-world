...
import ai.mechanical-wings.app.ui.mobileAccentBorderStrong
...
import ai.mechanical-wings.app.ui.mobileSurface
import ai.mechanical-wings.app.ui.mobileText
import ai.mechanical-wings.app.ui.mobileTextSecondary
import ai.mechanical-wings.app.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.mechanical-wings.app.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.mechanical-wings.app.ui.mobileFontFamily,
