...
import ai.mechanical-wings.app.voice.VoiceConversationRole
  ...
  Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.Start) {
    Surface(
      ...
      Row(
        ...
        Text("Wings🪽 is thinking…", style = mobileCallout, color = mobileTextSecondary)
      }
    }
  }
}
