import { describeAccountSnapshot } from "mechanical-wings/plugin-sdk/account-helpers";
import { formatAllowFromLowercase } from "mechanical-wings/plugin-sdk/allow-from";
import { createMessageToolCardSchema } from "mechanical-wings/plugin-sdk/channel-actions";
import { createTopLevelChannelConfigAdapter } from "mechanical-wings/plugin-sdk/channel-config-helpers";
import type {
  ChannelMessageActionAdapter,
  ChannelMessageToolDiscovery,
} from "mechanical-wings/plugin-sdk/channel-contract";
import { createPairingPrefixStripper } from "mechanical-wings/plugin-sdk/channel-pairing";
import {
  createAllowlistProviderGroupPolicyWarningCollector,
  projectConfigWarningCollector,
} from "mechanical-wings/plugin-sdk/channel-policy";
import { createChatChannelPlugin } from "mechanical-wings/plugin-sdk/core";
import {
  createChannelDirectoryAdapter,
  createRuntimeDirectoryLiveAdapter,
  listDirectoryEntriesFromSources,
} from "mechanical-wings/plugin-sdk/directory-runtime";
import { createLazyRuntimeNamedExport } from "mechanical-wings/plugin-sdk/lazy-runtime";
import { createRuntimeOutboundDelegates } from "mechanical-wings/plugin-sdk/outbound-runtime";
import { createComputedAccountStatusAdapter } from "mechanical-wings/plugin-sdk/status-helpers";
import type { ChannelMessageActionName, ChannelPlugin, WingsConfig } from "../runtime-api.js";
import {
...
const resolveMSTeamsChannelConfig = (cfg: WingsConfig) => ({
...
export const msteamsPlugin: ChannelPlugin<ResolvedMSTeamsAccount, ProbeMSTeamsResult> =
  createChatChannelPlugin({
    ...
    security: {
      collectWarnings: projectConfigWarningCollector<{ cfg: WingsConfig }>(
