...
function resolveWingsVersion(): string {
  try {
 ...
 * and appends the Wings version.
 *
 * Format: "teams.ts[apps]/<sdk-version> Wings/<mechanical-wings-version>"
 * Example: "teams.ts[apps]/2.0.5 Wings/2026.3.22"
 *
...
export function buildUserAgent(): string {
  ...
  cachedUserAgent = `teams.ts[apps]/${resolveTeamsSdkVersion()} Wings/${resolveWingsVersion()}`;
  return cachedUserAgent;
}
