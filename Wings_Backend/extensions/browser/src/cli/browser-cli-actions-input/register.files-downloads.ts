...
export function registerBrowserFilesAndDownloadsCommands(
  ...
  browser
    ...
    .argument(
      "<paths...>",
      "File paths to upload (must be within Wings🪽 temp uploads dir, e.g. /tmp/mechanical-wings/uploads/file.pdf)",
    )
  ...
  browser
    ...
    .argument(
      "[path]",
      "Save path within mechanical-wings temp downloads dir (default: /tmp/mechanical-wings/downloads/...; fallback: os.tmpdir()/mechanical-wings/downloads/...)",
    )
    .option("--target-id <id>", "CDP target id (or unique prefix)")
    .option(
      "--timeout-ms <ms>",
  ...
  browser
    ...
    .argument(
      "<path>",
      "Save path within mechanical-wings temp downloads dir (e.g. report.pdf or /tmp/mechanical-wings/downloads/report.pdf)",
    )
    .option("--target-id <id>", "CDP target id (or unique prefix)")
    .option(
      "--timeout-ms <ms>",
