import type { BrowserConfig, BrowserProfileConfig, WingsConfig } from "../config/config.js";
...
/**
 * Ensure the default "mechanical-wings" profile exists in the profiles map.
...
export function resolveProfile(
  ...
  let cdpUrl = "";
  const driver = profile.driver === "existing-session" ? "existing-session" : "mechanical-wings";
