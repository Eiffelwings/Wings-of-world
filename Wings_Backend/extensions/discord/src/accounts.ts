...
import { normalizeAccountId } from "mechanical-wings/plugin-sdk/account-id";
import { resolveAccountEntry } from "mechanical-wings/plugin-sdk/routing";
import type { DiscordAccountConfig, DiscordActionConfig, WingsConfig } from "./runtime-api.js";
...
export function listEnabledDiscordAccounts(cfg: WingsConfig): ResolvedDiscordAccount[] {
