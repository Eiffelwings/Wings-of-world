...
vi.mock("mechanical-wings/plugin-sdk/web-media", async () => {
...
let loadWebMedia: typeof import("mechanical-wings/plugin-sdk/web-media").loadWebMedia;
...
beforeAll(async () => {
  ...
  ({ loadWebMedia } = await import("mechanical-wings/plugin-sdk/web-media"));
