...
import type { WingsConfig, loadConfig } from "mechanical-wings/plugin-sdk/config-runtime";
import { isDangerousNameMatchingEnabled } from "mechanical-wings/plugin-sdk/config-runtime";
import { resolveOpenProviderRuntimeGroupPolicy } from "mechanical-wings/plugin-sdk/config-runtime";
import { buildPairingReply } from "mechanical-wings/plugin-sdk/conversation-runtime";
import { getAgentScopedMediaLocalRoots } from "mechanical-wings/plugin-sdk/media-runtime";
import * as pluginRuntime from "mechanical-wings/plugin-sdk/plugin-runtime";
import {
  resolveSendableOutboundReplyParts,
  resolveTextChunksWithFallback,
} from "mechanical-wings/plugin-sdk/reply-payload";
import * as replyRuntime from "mechanical-wings/plugin-sdk/reply-runtime";
...
type DiscordConfig = NonNullable<WingsConfig["channels"]>["discord"];
