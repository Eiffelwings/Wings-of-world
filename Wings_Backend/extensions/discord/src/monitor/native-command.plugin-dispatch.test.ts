...
import type { WingsConfig } from "../../../../src/config/config.js";
...
function createConfig(): WingsConfig {
  return {
    channels: {
      discord: {
...
async function createNativeCommand(cfg: WingsConfig, commandSpec: NativeCommandSpec) {
...
async function createPluginCommand(params: { cfg: WingsConfig; name: string }) {
  return createDiscordNativeCommand({
    command: {
      name: params.name,
      description: "Pair",
...
async function createStatusCommand(cfg: WingsConfig) {
...
describe("Discord native plugin command dispatch", () => {
  ...
  beforeEach(async () => {
    ...
    const actualPluginRuntime = await vi.importActual<
      typeof import("mechanical-wings/plugin-sdk/plugin-runtime")
    >("mechanical-wings/plugin-sdk/plugin-runtime");
    ...
    discordNativeCommandTesting.setMatchPluginCommand(
      runtimeModuleMocks.matchPluginCommand as typeof import("mechanical-wings/plugin-sdk/plugin-runtime").matchPluginCommand,
    );
    discordNativeCommandTesting.setExecutePluginCommand(
      runtimeModuleMocks.executePluginCommand as typeof import("mechanical-wings/plugin-sdk/plugin-runtime").executePluginCommand,
    );
    discordNativeCommandTesting.setDispatchReplyWithDispatcher(
      runtimeModuleMocks.dispatchReplyWithDispatcher as typeof import("mechanical-wings/plugin-sdk/reply-runtime").dispatchReplyWithDispatcher,
    );
