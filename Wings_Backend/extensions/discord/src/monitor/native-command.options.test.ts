...
import type { WingsConfig, loadConfig } from "../../../../src/config/config.js";
...
function createNativeCommand(
  ...
  opts?: {
    ...
    discordConfig?: NonNullable<WingsConfig["channels"]>["discord"];
  },
...
describe("createDiscordNativeCommand option wiring", () => {
  ...
  it("truncates Discord command and option descriptions to Discord's limit", () => {
    ...
    const discordConfig = {} as NonNullable<WingsConfig["channels"]>["discord"];
