...
import { normalizeAccountId, resolveAgentIdFromSessionKey } from "mechanical-wings/plugin-sdk/routing";
...
const THREAD_BINDINGS_STATE_KEY = Symbol.for("mechanical-wings.discordThreadBindingsState");
