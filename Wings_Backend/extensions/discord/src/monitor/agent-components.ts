...
import { resolveHumanDelayConfig } from "mechanical-wings/plugin-sdk/agent-runtime";
import {
  formatInboundEnvelope,
  resolveEnvelopeFormatOptions,
} from "mechanical-wings/plugin-sdk/channel-inbound";
import { createChannelReplyPipeline } from "mechanical-wings/plugin-sdk/channel-reply-pipeline";
import type { WingsConfig } from "mechanical-wings/plugin-sdk/config-runtime";
import { isDangerousNameMatchingEnabled } from "mechanical-wings/plugin-sdk/config-runtime";
import { resolveMarkdownTableMode } from "mechanical-wings/plugin-sdk/config-runtime";
import { readSessionUpdatedAt, resolveStorePath } from "mechanical-wings/plugin-sdk/config-runtime";
import type { DiscordAccountConfig } from "mechanical-wings/plugin-sdk/config-runtime";
import {
  buildPluginBindingResolvedText,
  parsePluginBindingApprovalCustomId,
  resolvePluginConversationBindingApproval,
} from "mechanical-wings/plugin-sdk/conversation-runtime";
import { recordInboundSession } from "mechanical-wings/plugin-sdk/conversation-runtime";
import { enqueueSystemEvent } from "mechanical-wings/plugin-sdk/infra-runtime";
import { getAgentScopedMediaLocalRoots } from "mechanical-wings/plugin-sdk/media-runtime";
import {
  dispatchPluginInteractiveHandler,
  type PluginInteractiveDiscordHandlerContext,
} from "mechanical-wings/plugin-sdk/plugin-runtime";
import { resolveChunkMode, resolveTextChunkLimit } from "mechanical-wings/plugin-sdk/reply-runtime";
import { finalizeInboundContext } from "mechanical-wings/plugin-sdk/reply-runtime";
import { dispatchReplyWithBufferedBlockDispatcher } from "mechanical-wings/plugin-sdk/reply-runtime";
import { createReplyReferencePlanner } from "mechanical-wings/plugin-sdk/reply-runtime";
import { resolveAgentRoute } from "mechanical-wings/plugin-sdk/routing";
...
import { logDebug, logError } from "mechanical-wings/plugin-sdk/text-runtime";
...
class DiscordComponentButton extends Button {
  label = "component";
  customId = "__mechanical-wings_discord_component_button_wildcard__";
  style = ButtonStyle.Primary;
...
class DiscordComponentStringSelect extends StringSelectMenu {
  customId = "__mechanical-wings_discord_component_string_select_wildcard__";
  options: APIStringSelectComponent["options"] = [];
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentUserSelect extends UserSelectMenu {
  customId = "__mechanical-wings_discord_component_user_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentRoleSelect extends RoleSelectMenu {
  customId = "__mechanical-wings_discord_component_role_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentMentionableSelect extends MentionableSelectMenu {
  customId = "__mechanical-wings_discord_component_mentionable_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentChannelSelect extends ChannelSelectMenu {
  customId = "__mechanical-wings_discord_component_channel_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentModal extends Modal {
  title = "Wings form";
  customId = "__mechanical-wings_discord_component_modal_wildcard__";
  components = [];
