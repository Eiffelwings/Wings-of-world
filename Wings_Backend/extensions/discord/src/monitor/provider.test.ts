...
function createConfigWithDiscordAccount(overrides: Record<string, unknown> = {}): WingsConfig {
  return {
    channels: {
      discord: {
        accounts: {
...
vi.mock("mechanical-wings/plugin-sdk/plugin-runtime", async () => {
  const actual = await vi.importActual<typeof import("mechanical-wings/plugin-sdk/plugin-runtime")>(
