...
import type { resolveAgentRoute } from "mechanical-wings/plugin-sdk/routing";
...
export type LoadedConfig = ReturnType<
  typeof import("mechanical-wings/plugin-sdk/config-runtime").loadConfig
>;
export type RuntimeEnv = import("mechanical-wings/plugin-sdk/runtime-env").RuntimeEnv;
...
type DiscordMessagePreflightSharedFields = {
  ...
  discordConfig: NonNullable<
    import("mechanical-wings/plugin-sdk/config-runtime").WingsConfig["channels"]
  >["discord"];
  accountId: string;
  token: string;
  runtime: RuntimeEnv;
