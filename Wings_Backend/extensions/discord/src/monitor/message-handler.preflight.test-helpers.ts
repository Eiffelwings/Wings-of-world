...
export type DiscordConfig = NonNullable<WingsConfig["channels"]>["discord"];
...
export function createDiscordPreflightArgs(params: {
  ...
  return {
    ...
    accountId: "default",
    token: "token",
    runtime: {} as import("mechanical-wings/plugin-sdk/runtime-env").RuntimeEnv,
    botUserId: params.botUserId ?? "mechanical-wings-bot",
