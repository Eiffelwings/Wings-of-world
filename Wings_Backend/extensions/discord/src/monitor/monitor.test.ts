...
import { buildPluginBindingApprovalCustomId } from "mechanical-wings/plugin-sdk/conversation-runtime";
...
async function createInfraRuntimeMock(
  importOriginal: () => Promise<typeof import("mechanical-wings/plugin-sdk/infra-runtime")>,
) {
...
vi.mock("mechanical-wings/plugin-sdk/infra-runtime", createInfraRuntimeMock);
vi.mock("mechanical-wings/plugin-sdk/infra-runtime.js", createInfraRuntimeMock);
...
describe("discord component interactions", () => {
  ...
  beforeEach(async () => {
    ...
    resolveStorePathMock.mockClear().mockReturnValue("/tmp/mechanical-wings-sessions-test.json");
