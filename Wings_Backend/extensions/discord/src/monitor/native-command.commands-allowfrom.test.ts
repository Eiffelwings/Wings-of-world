...
function createCommand(cfg: WingsConfig, discordConfig?: DiscordAccountConfig) {
...
function createDispatchSpy() {
  ...
  nativeCommandTesting.setDispatchReplyWithDispatcher(
    dispatcherModule.dispatchReplyWithDispatcher as typeof import("mechanical-wings/plugin-sdk/reply-runtime").dispatchReplyWithDispatcher,
  );
  return dispatchSpy;
}
...
async function runGuildSlashCommand(params?: {
  userId?: string;
  mutateConfig?: (cfg: WingsConfig) => void;
