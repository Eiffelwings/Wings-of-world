...
import { formatDurationSeconds } from "mechanical-wings/plugin-sdk/infra-runtime";
...
type LoadedConfig = ReturnType<typeof import("mechanical-wings/plugin-sdk/config-runtime").loadConfig>;
type RuntimeEnv = import("mechanical-wings/plugin-sdk/runtime-env").RuntimeEnv;
type Logger = ReturnType<typeof import("mechanical-wings/plugin-sdk/runtime-env").createSubsystemLogger>;
