...
import { resolveCommandAuthorizedFromAuthorizers } from "mechanical-wings/plugin-sdk/command-auth";
...
import * as securityRuntime from "mechanical-wings/plugin-sdk/security-runtime";
import { logError } from "mechanical-wings/plugin-sdk/text-runtime";
import {
...
export type AgentComponentContext = {
  ...
  runtime?: import("mechanical-wings/plugin-sdk/runtime-env").RuntimeEnv;
  token?: string;
