...
import { getPluginCommandSpecs } from "mechanical-wings/plugin-sdk/plugin-runtime";
...
import {
  ...
  shouldLogVerbose,
  warn,
} from "mechanical-wings/plugin-sdk/runtime-env";
...
import { summarizeStringEntries } from "mechanical-wings/plugin-sdk/text-runtime";
...
export async function monitorDiscordProvider(opts: MonitorDiscordOpts = {}) {
  ...
  try {
    ...
    const guildHistories = new Map<
      string,
      import("mechanical-wings/plugin-sdk/reply-history").HistoryEntry[]
    >();
