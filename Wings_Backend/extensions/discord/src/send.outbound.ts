...
import { loadConfig, type WingsConfig } from "mechanical-wings/plugin-sdk/config-runtime";
...
import { maxBytesForKind } from "mechanical-wings/plugin-sdk/media-runtime";
import { extensionForMime } from "mechanical-wings/plugin-sdk/media-runtime";
import { unlinkIfExists } from "mechanical-wings/plugin-sdk/media-runtime";
import type { PollInput } from "mechanical-wings/plugin-sdk/media-runtime";
...
import { loadWebMediaRaw } from "mechanical-wings/plugin-sdk/web-media";
...
async function materializeVoiceMessageInput(mediaUrl: string): Promise<{ filePath: string }> {
  ...
  const tempDir = resolvePreferredWingsTmpDir();
