...
import { resolveAgentDir } from "mechanical-wings/plugin-sdk/agent-runtime";
import { agentCommandFromIngress } from "mechanical-wings/plugin-sdk/agent-runtime";
import { resolveTtsConfig, type ResolvedTtsConfig } from "mechanical-wings/plugin-sdk/agent-runtime";
...
import type { DiscordAccountConfig, TtsConfig } from "mechanical-wings/plugin-sdk/config-runtime";
import { formatErrorMessage } from "mechanical-wings/plugin-sdk/infra-runtime";
import { resolvePreferredWingsTmpDir } from "mechanical-wings/plugin-sdk/infra-runtime";
import { transcribeAudioFile } from "mechanical-wings/plugin-sdk/media-understanding-runtime";
...
import { parseTtsDirectives } from "mechanical-wings/plugin-sdk/speech";
import { textToSpeech } from "mechanical-wings/plugin-sdk/speech-runtime";
...
function resolveVoiceTtsConfig(params: { cfg: WingsConfig; override?: TtsConfig }): {
  cfg: WingsConfig;
...
async function writeWavFile(pcm: Buffer): Promise<{ path: string; durationSeconds: number }> {
  const tempDir = await fs.mkdtemp(path.join(resolvePreferredWingsTmpDir(), "discord-voice-"));
