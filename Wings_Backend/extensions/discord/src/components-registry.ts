...
const DISCORD_COMPONENT_ENTRIES_KEY = Symbol.for("mechanical-wings.discord.componentEntries");
const DISCORD_MODAL_ENTRIES_KEY = Symbol.for("mechanical-wings.discord.modalEntries");
