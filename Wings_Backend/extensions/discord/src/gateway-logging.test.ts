...
vi.mock("mechanical-wings/plugin-sdk/runtime-env", () => ({
  logVerbose: vi.fn(),
}));

let logVerbose: typeof import("mechanical-wings/plugin-sdk/runtime-env").logVerbose;
...
describe("attachDiscordGatewayLogging", () => {
  beforeEach(async () => {
    vi.resetModules();
    ({ logVerbose } = await import("mechanical-wings/plugin-sdk/runtime-env"));
