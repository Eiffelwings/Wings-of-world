# @mechanical-wings/voice-call

Official Voice Call plugin for **Wings🪽**.
...
Docs: `https://docs.wings-of-world.ai/plugins/voice-call`
Plugin system: `https://docs.wings-of-world.ai/plugin`

## Install (local dev)

### Option A: install via Wings🪽 (recommended)
...
```bash
mkdir -p ~/.mechanical-wings/extensions
cp -R extensions/voice-call ~/.mechanical-wings/extensions/voice-call
cd ~/.mechanical-wings/extensions/voice-call && pnpm install
```
...
- advanced webhook, streaming, and tunnel notes: `https://docs.wings-of-world.ai/plugins/voice-call`

## Stale call reaper

See the plugin docs for recommended ranges and production examples:
`https://docs.wings-of-world.ai/plugins/voice-call#stale-call-reaper`

## TTS for calls

Voice Call uses the core `messages.tts` configuration for
streaming speech on calls. Override examples and provider caveats live here:
`https://docs.wings-of-world.ai/plugins/voice-call#tts-for-calls`

## CLI

```bash
mechanical-wings voicecall call --to "+15555550123" --message "Hello from Wings🪽"
mechanical-wings voicecall continue --call-id <id> --message "Any questions?"
mechanical-wings voicecall speak --call-id <id> --message "One moment"
mechanical-wings voicecall end --call-id <id>
mechanical-wings voicecall status --call-id <id>
mechanical-wings voicecall tail
