import type { ImageGenerationProvider } from "mechanical-wings/plugin-sdk/image-generation";
import type { MediaUnderstandingProvider } from "mechanical-wings/plugin-sdk/media-understanding";
import {
  definePluginEntry,
  type WingsPluginApi,
...
import { createProviderApiKeyAuthMethod } from "mechanical-wings/plugin-sdk/provider-auth-api-key";
import {
  GOOGLE_GEMINI_DEFAULT_MODEL,
  applyGoogleGeminiModelDefault,
  createGoogleThinkingPayloadWrapper,
} from "mechanical-wings/plugin-sdk/provider-google";
import type { ProviderPlugin } from "mechanical-wings/plugin-sdk/provider-models";
...
async function loadGoogleGeminiCliProvider(): Promise<ProviderPlugin> {
  if (!googleGeminiCliProviderPromise) {
    googleGeminiCliProviderPromise = import("./gemini-cli-provider.js").then((mod) => {
      ...
      } as Pick<WingsPluginApi, "registerProvider"> as WingsPluginApi);
      if (!provider) {
