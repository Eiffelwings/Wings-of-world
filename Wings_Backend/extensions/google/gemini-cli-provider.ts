...
import { buildOauthProviderAuthResult } from "mechanical-wings/plugin-sdk/provider-auth-result";
import { fetchGeminiUsage } from "mechanical-wings/plugin-sdk/provider-usage";
...
export function registerGoogleGeminiCliProvider(api: WingsPluginApi) {
