...
} from "mechanical-wings/plugin-sdk/provider-auth";
import { buildOauthProviderAuthResult } from "mechanical-wings/plugin-sdk/provider-auth";
import { loginOpenAICodexOAuth } from "mechanical-wings/plugin-sdk/provider-auth-login";
import {
...
import { createOpenAIAttributionHeadersWrapper } from "mechanical-wings/plugin-sdk/provider-stream";
import { fetchCodexUsage } from "mechanical-wings/plugin-sdk/provider-usage";
...
function buildOpenAICodexAuthDoctorHint(ctx: { profileId?: string }) {
  ...
  return "Deprecated profile. Run `mechanical-wings models auth login --provider openai-codex` or `mechanical-wings configure`.";
}
