import type { ChannelSetupAdapter, WingsConfig } from "mechanical-wings/plugin-sdk/setup";
...
export function isLineConfigured(cfg: WingsConfig, accountId: string): boolean {
