...
vi.mock("mechanical-wings/plugin-sdk/reply-runtime", () => ({
...
vi.mock("mechanical-wings/plugin-sdk/channel-reply-pipeline", () => ({
  createChannelReplyPipeline: vi.fn(() => ({})),
}));

vi.mock("mechanical-wings/plugin-sdk/webhook-ingress", () => ({
