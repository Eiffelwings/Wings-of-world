...
function enableSlackAccount(cfg: WingsConfig, accountId: string): WingsConfig {
...
function hasSlackInteractiveRepliesConfig(cfg: WingsConfig, accountId: string): boolean {
...
function createSlackTokenCredential(params: {
  ...
  return {
    ...
    applyUseEnv: ({ cfg, accountId }: { cfg: WingsConfig; accountId: string }) =>
