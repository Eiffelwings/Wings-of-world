import { resolveMarkdownTableMode as resolveMarkdownTableModeImpl } from "mechanical-wings/plugin-sdk/config-runtime";
import {
...
import { resolveAgentRoute as resolveAgentRouteImpl } from "mechanical-wings/plugin-sdk/routing";
import { deliverSlackSlashReplies as deliverSlackSlashRepliesImpl } from "./replies.js";

type ResolveChunkMode = typeof import("mechanical-wings/plugin-sdk/reply-runtime").resolveChunkMode;
type FinalizeInboundContext =
  typeof import("mechanical-wings/plugin-sdk/reply-runtime").finalizeInboundContext;
type DispatchReplyWithDispatcher =
  typeof import("mechanical-wings/plugin-sdk/reply-runtime").dispatchReplyWithDispatcher;
type ResolveConversationLabel =
  typeof import("mechanical-wings/plugin-sdk/conversation-runtime").resolveConversationLabel;
...
type ResolveMarkdownTableMode =
  typeof import("mechanical-wings/plugin-sdk/config-runtime").resolveMarkdownTableMode;
type ResolveAgentRoute = typeof import("mechanical-wings/plugin-sdk/routing").resolveAgentRoute;
