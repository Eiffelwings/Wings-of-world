...
import { readSessionUpdatedAt } from "mechanical-wings/plugin-sdk/config-runtime";
...
export async function resolveSlackThreadContextData(params: {
  ...
  envelopeOptions: ReturnType<
    typeof import("mechanical-wings/plugin-sdk/channel-inbound").resolveEnvelopeFormatOptions
  >;
