...
import { resolveSessionKey, type SessionScope } from "mechanical-wings/plugin-sdk/config-runtime";
import type { DmPolicy, GroupPolicy } from "mechanical-wings/plugin-sdk/config-runtime";
import { createDedupeCache } from "mechanical-wings/plugin-sdk/infra-runtime";
import type { HistoryEntry } from "mechanical-wings/plugin-sdk/reply-history";
...
export type SlackMonitorContext = {
  ...
  slashCommand: Required<import("mechanical-wings/plugin-sdk/config-runtime").SlackSlashCommandConfig>;
  textLimit: number;
