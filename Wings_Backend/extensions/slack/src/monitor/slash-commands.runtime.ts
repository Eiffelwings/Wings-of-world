...
type BuildCommandTextFromArgs =
  typeof import("mechanical-wings/plugin-sdk/command-auth").buildCommandTextFromArgs;
type FindCommandByNativeName =
  typeof import("mechanical-wings/plugin-sdk/command-auth").findCommandByNativeName;
type ListNativeCommandSpecsForConfig =
  typeof import("mechanical-wings/plugin-sdk/command-auth").listNativeCommandSpecsForConfig;
type ParseCommandArgs = typeof import("mechanical-wings/plugin-sdk/command-auth").parseCommandArgs;
type ResolveCommandArgMenu =
  typeof import("mechanical-wings/plugin-sdk/command-auth").resolveCommandArgMenu;
