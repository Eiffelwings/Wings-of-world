...
vi.mock("mechanical-wings/plugin-sdk/infra-runtime", async (importOriginal) => {
...
vi.mock("mechanical-wings/plugin-sdk/plugin-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("mechanical-wings/plugin-sdk/plugin-runtime")>();
  return {
    ...actual,
...
vi.mock("mechanical-wings/plugin-sdk/conversation-runtime", async () => {
  const actual = await vi.importActual<typeof import("mechanical-wings/plugin-sdk/conversation-runtime")>(
    "mechanical-wings/plugin-sdk/conversation-runtime",
  );
  return {
    ...actual,
...
describe("registerSlackInteractionEvents", () => {
  ...
  it("enqueues structured events and updates button rows", async () => {
    ...
    await handler!({
          ...
          blocks: [
            {
              ...
              elements: [{ type: "button", action_id: "mechanical-wings:verify" }],
            },
          ],
        },
      },
      action: {
        type: "button",
        action_id: "mechanical-wings:verify",
        block_id: "verify_block",
        value: "approved",
    ...
    expect(payload).toMatchObject({
      actionId: "mechanical-wings:verify",
      actionType: "button",
      value: "approved",
      userId: "U123",
      teamId: "T9",
  ...
  it("registers a matcher that accepts plugin action ids beyond the Wings🪽 prefix", () => {
    const { ctx, getActionMatcher } = createContext();
    registerSlackInteractionEvents({ ctx: ctx as never });

    const matcher = getActionMatcher();
    expect(matcher).toBeTruthy();
    expect(matcher?.test("mechanical-wings:verify")).toBe(true);
  ...
  it("treats Slack reply buttons as plain interaction events instead of plugin dispatch", async () => {
    ...
    await handler!({
          ...
          blocks: [
            {
              ...
              elements: [{ type: "button", action_id: "mechanical-wings:reply_button" }],
            },
          ],
        },
      },
      action: {
        type: "button",
        action_id: "mechanical-wings:reply_button",
        block_id: "reply_actions",
        value: "codex",
    ...
    expect(enqueueSystemEventMock).toHaveBeenCalledWith(
      expect.stringContaining('"actionId":"mechanical-wings:reply_button"'),
      expect.any(Object),
    );
    expect(app.client.chat.update).toHaveBeenCalledTimes(1);
  });
  ...
  it("drops modal lifecycle payloads when mismatch guard triggers", async () => {
    ...
    await viewHandler!({
      ...
      body: {
        ...
        view: {
          id: "V123",
          callback_id: "mechanical-wings:deploy_form",
  ...
  it("captures select values and updates action rows for non-button actions", async () => {
    ...
    await handler!({
      ...
      action: {
        type: "static_select",
        action_id: "mechanical-wings:pick",
  ...
  it("falls back to container channel and message timestamps", async () => {
    ...
    await handler!({
      ...
      action: {
        type: "button",
        action_id: "mechanical-wings:container",
  ...
  it("summarizes multi-select confirmations in updated message rows", async () => {
    ...
    await handler!({
          ...
          blocks: [
            {
              ...
              elements: [{ type: "multi_static_select", action_id: "mechanical-wings:multi" }],
            },
          ],
        },
      },
      action: {
        ...
        action_id: "mechanical-wings:multi",
        block_id: "multi_block",
        selected_options: [
  ...
  it("renders date/time/datetime picker selections in confirmation rows", async () => {
    ...
    await handler!({
          ...
          blocks: [
            {
              type: "actions",
              block_id: "date_block",
              elements: [{ type: "datepicker", action_id: "mechanical-wings:date" }],
            },
            {
              type: "actions",
              block_id: "time_block",
              elements: [{ type: "timepicker", action_id: "mechanical-wings:time" }],
            },
            {
              type: "actions",
              block_id: "datetime_block",
              elements: [{ type: "datetimepicker", action_id: "mechanical-wings:datetime" }],
            },
          ],
        },
      },
      action: {
        type: "datepicker",
        action_id: "mechanical-wings:date",
        block_id: "date_block",
    ...
    await handler!({
      ...
      action: {
        type: "timepicker",
        action_id: "mechanical-wings:time",
        block_id: "time_block",
        selected_time: "14:30",
      },
    });
    ...
    await handler!({
      ...
      action: {
        type: "datetimepicker",
        action_id: "mechanical-wings:datetime",
        block_id: "datetime_block",
  ...
  it("captures expanded selection and temporal payload fields", async () => {
    ...
    await handler!({
      ...
      action: {
        ...
        action_id: "mechanical-wings:route",
        selected_user: "U777",
  ...
  it("captures workflow button trigger metadata", async () => {
    ...
    await handler!({
      ...
      action: {
        ...
        action_id: "mechanical-wings:workflow",
  ...
  it("captures modal submissions and enqueues view submission event", async () => {
    ...
    expect(payload).toMatchObject({
      ...
      actionId: "view:mechanical-wings:deploy_form",
      callbackId: "mechanical-wings:deploy_form",
      viewId: "V123",
      userId: "U777",
  ...
  it("captures modal input labels and picker values across block types", async () => {
    ...
    await viewHandler!({
      ...
      body: {
        ...
        view: {
          id: "V400",
          callback_id: "mechanical-wings:routing_form",
            ...
            values: {
              ...
              email_block: {
                email_input: {
                  ...
                  value: "team@wings-of-world.ai",
                },
              },
              url_block: {
                url_input: {
                  type: "url_text_input",
                  value: "https://docs.wings-of-world.ai",
                },
              },
              richtext_block: {
                richtext_input: {
    ...
    expect(payload.inputs).toEqual(
      expect.arrayContaining([
        ...
        expect.objectContaining({
          ...
          inputKind: "email",
          inputEmail: "team@wings-of-world.ai",
        }),
        expect.objectContaining({
          actionId: "url_input",
          inputKind: "url",
          inputUrl: "https://docs.wings-of-world.ai/",
        }),
        expect.objectContaining({
  ...
  it("truncates rich text preview to keep payload summaries compact", async () => {
    ...
    await viewHandler!({
      ...
      body: {
        ...
        view: {
          id: "V555",
          callback_id: "mechanical-wings:long_richtext",
  ...
  it("caps oversized interaction payloads with compact summaries", async () => {
    ...
    await viewHandler!({
      ...
      body: {
        ...
        view: {
          id: "V915",
          callback_id: "mechanical-wings:oversize",
          private_metadata: JSON.stringify({
            channelId: "D915",
            channelType: "im",
            userId: "U915",
