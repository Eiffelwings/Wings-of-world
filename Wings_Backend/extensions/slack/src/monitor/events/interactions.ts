...
// Prefix for Wings-generated action IDs to scope our handler
const OPENCLAW_ACTION_PREFIX = "mechanical-wings:";
...
export function registerSlackInteractionEvents(params: { ctx: SlackMonitorContext }) {
  ...
  // Handle Wings modal submissions with callback_ids scoped by our prefix.
  registerModalLifecycleHandler({
