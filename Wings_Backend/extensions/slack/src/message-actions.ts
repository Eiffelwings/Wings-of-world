import { createActionGate } from "mechanical-wings/plugin-sdk/agent-runtime";
import type { ChannelMessageActionName } from "mechanical-wings/plugin-sdk/channel-contract";
import type { WingsConfig } from "mechanical-wings/plugin-sdk/config-runtime";
import type { ChannelToolSend } from "mechanical-wings/plugin-sdk/tool-send";
import { listEnabledSlackAccounts } from "./accounts.js";

export function listSlackMessageActions(cfg: WingsConfig): ChannelMessageActionName[] {
