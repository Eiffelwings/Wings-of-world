...
import { createChannelPluginBase } from "mechanical-wings/plugin-sdk/core";
import {
  formatDocsLink,
...
import { getChatChannelMeta, type ChannelPlugin, type WingsConfig } from "./runtime-api.js";

export const SLACK_CHANNEL = "slack" as const;

function buildSlackManifest(botName: string) {
  const safeName = botName.trim() || "Wings";
  const manifest = {
    display_information: {
      name: safeName,
      description: `${safeName} connector for Wings`,
    },
    features: {
      bot_user: {
...
export function buildSlackSetupLines(botName = "Wings"): string[] {
  return [
