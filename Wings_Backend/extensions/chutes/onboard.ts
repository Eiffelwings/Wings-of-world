 ...
 */
export function applyChutesProviderConfig(cfg: WingsConfig): WingsConfig {
 ...
 */
export function applyChutesConfig(cfg: WingsConfig): WingsConfig {
...
export function applyChutesApiKeyConfig(cfg: WingsConfig): WingsConfig {
