...
import { resolveDualTextControlCommandGate } from "mechanical-wings/plugin-sdk/command-auth";
...
import { sanitizeTerminalText } from "mechanical-wings/plugin-sdk/text-runtime";
