...
import { createChannelPairingChallengeIssuer } from "mechanical-wings/plugin-sdk/channel-pairing";
...
} from "mechanical-wings/plugin-sdk/config-runtime";
...
import { normalizeScpRemoteHost } from "mechanical-wings/plugin-sdk/infra-runtime";
import { waitForTransportReady } from "mechanical-wings/plugin-sdk/infra-runtime";
import {
  isInboundPathAllowed,
  resolveIMessageAttachmentRoots,
  resolveIMessageRemoteAttachmentRoots,
} from "mechanical-wings/plugin-sdk/media-runtime";
import { kindFromMime } from "mechanical-wings/plugin-sdk/media-runtime";
import {
  clearHistoryEntriesIfEnabled,
  DEFAULT_GROUP_HISTORY_LIMIT,
  type HistoryEntry,
} from "mechanical-wings/plugin-sdk/reply-history";
import { resolveTextChunkLimit } from "mechanical-wings/plugin-sdk/reply-runtime";
...
import { danger, logVerbose, shouldLogVerbose, warn } from "mechanical-wings/plugin-sdk/runtime-env";
import { resolvePinnedMainDmOwnerFromAllowlist } from "mechanical-wings/plugin-sdk/security-runtime";
 ...
 *   exec ssh -T mechanical-wings@192.168.64.3 /opt/homebrew/bin/imsg "$@"
...
async function detectRemoteHostFromCliPath(cliPath: string): Promise<string | undefined> {
  try {
    ...
    // Match user@host pattern first (e.g., mechanical-wings@192.168.64.3)
