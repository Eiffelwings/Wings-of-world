...
function buildDispatchContextPayload(params: { cfg: WingsConfig; message: IMessagePayload }) {
  ...
  it("blocks group messages when imessage.groups is set without a wildcard", () => {
    ...
    const decision = resolveIMessageInboundDecision({
      ...
      message: {
        ...
        sender: "+15550001111",
        is_from_me: false,
        text: "@mechanical-wings hello",
        is_group: true,
      },
      opts: {},
      messageText: "@mechanical-wings hello",
      bodyText: "@mechanical-wings hello",
      allowFrom: ["*"],
      groupAllowFrom: [],
      groupPolicy: "open",
      dmPolicy: "open",
  ...
  it("honors group allowlist and ignores pairing-store senders in groups", () => {
    ...
    const denied = resolveIMessageInboundDecision({
      ...
      message: {
        ...
        sender: "+15550003333",
        is_from_me: false,
        text: "@mechanical-wings hi",
        is_group: true,
      },
      opts: {},
      messageText: "@mechanical-wings hi",
      bodyText: "@mechanical-wings hi",
      allowFrom: ["*"],
    ...
    const allowed = resolveIMessageInboundDecision({
      ...
      message: {
        ...
        sender: "+15550003333",
        is_from_me: false,
        text: "@mechanical-wings ok",
        is_group: true,
      },
      opts: {},
      messageText: "@mechanical-wings ok",
      bodyText: "@mechanical-wings ok",
      allowFrom: ["*"],
      groupAllowFrom: ["chat_id:101"],
      groupPolicy: "allowlist",
      dmPolicy: "pairing",
