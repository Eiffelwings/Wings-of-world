...
function mergeIMessageAccountConfig(cfg: WingsConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: WingsConfig): ResolvedIMessageAccount[] {
