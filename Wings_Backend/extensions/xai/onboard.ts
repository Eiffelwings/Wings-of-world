...
>({
  ...
  resolveParams: (_cfg: WingsConfig, api) => ({
    providerId: "xai",
    api,
...
export function applyXaiProviderConfig(cfg: WingsConfig): WingsConfig {
  return xaiPresetAppliers.applyProviderConfig(cfg, "openai-completions");
}

export function applyXaiResponsesApiConfig(cfg: WingsConfig): WingsConfig {
  return xaiPresetAppliers.applyProviderConfig(cfg, "openai-responses");
}

export function applyXaiConfig(cfg: WingsConfig): WingsConfig {
