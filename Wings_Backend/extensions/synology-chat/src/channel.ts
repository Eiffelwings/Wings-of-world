/**
 * Synology Chat Channel Plugin for Wings.
 *
 * Implements the ChannelPlugin interface following the LINE pattern.
 */

import type { WingsConfig } from "mechanical-wings/plugin-sdk/account-resolution";
import {
  createHybridChannelConfigAdapter,
  createScopedDmSecurityResolver,
} from "mechanical-wings/plugin-sdk/channel-config-helpers";
import { waitUntilAbort } from "mechanical-wings/plugin-sdk/channel-lifecycle";
import {
...
import { attachChannelToResult } from "mechanical-wings/plugin-sdk/channel-send-result";
import { createChatChannelPlugin, type ChannelPlugin } from "mechanical-wings/plugin-sdk/core";
import { createEmptyChannelDirectoryAdapter } from "mechanical-wings/plugin-sdk/directory-runtime";
import { DEFAULT_ACCOUNT_ID } from "mechanical-wings/plugin-sdk/setup";
...
const resolveSynologyChatDmPolicy = createScopedDmSecurityResolver<ResolvedSynologyChatAccount>({
  ...
  approveHint: "mechanical-wings pairing approve synology-chat <code>",
...
> & {
  pairing: {
    ...
    notifyApproval: (params: { cfg: WingsConfig; id: string }) => Promise<void>;
  };
  security: {
    resolveDmPolicy: (params: { cfg: WingsConfig; account: ResolvedSynologyChatAccount }) => {
  ...
  return createChatChannelPlugin({
    base: {
      ...
      meta: {
        ...
        blurb: "Connect your Synology NAS Chat to Wings",
        order: 90,
      },
      capabilities: {
    ...
    pairing: {
      text: {
        ...
        message: "Wings: your access has been approved.",
