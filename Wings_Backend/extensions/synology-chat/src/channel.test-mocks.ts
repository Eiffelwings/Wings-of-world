...
vi.mock("mechanical-wings/plugin-sdk/setup", async () => {
  const actual = await vi.importActual<object>("mechanical-wings/plugin-sdk/setup");
  return {
    ...actual,
...
vi.mock("mechanical-wings/plugin-sdk/channel-config-schema", async () => {
  const actual = await vi.importActual<object>("mechanical-wings/plugin-sdk/channel-config-schema");
  return {
    ...actual,
...
vi.mock("mechanical-wings/plugin-sdk/webhook-ingress", async () => {
  const actual = await vi.importActual<object>("mechanical-wings/plugin-sdk/webhook-ingress");
  return {
    ...actual,
