import { DEFAULT_ACCOUNT_ID, type WingsConfig } from "mechanical-wings/plugin-sdk/account-resolution";
import { waitUntilAbort } from "mechanical-wings/plugin-sdk/channel-lifecycle";
import { registerPluginHttpRoute } from "mechanical-wings/plugin-sdk/webhook-ingress";
