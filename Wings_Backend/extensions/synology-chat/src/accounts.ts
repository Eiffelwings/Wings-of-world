...
import { resolveDangerousNameMatchingEnabled } from "mechanical-wings/plugin-sdk/config-runtime";
import type {
...
/** Extract the channel config from the full Wings config object. */
function getChannelConfig(cfg: WingsConfig): SynologyChatChannelConfig | undefined {
 ...
 */
export function listAccountIds(cfg: WingsConfig): string[] {
...
export function resolveAccount(
  ...
  const envBotName = process.env.OPENCLAW_BOT_NAME ?? "Wings";
