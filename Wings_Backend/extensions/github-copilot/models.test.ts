...
vi.mock("mechanical-wings/plugin-sdk/provider-models", () => ({
...
vi.mock("mechanical-wings/plugin-sdk/json-store", () => ({
  loadJsonFile,
  saveJsonFile,
}));

vi.mock("mechanical-wings/plugin-sdk/state-paths", () => ({
  resolveStateDir: () => "/tmp/mechanical-wings-state",
}));

import type { ProviderResolveDynamicModelContext } from "mechanical-wings/plugin-sdk/core";
...
describe("github-copilot token", () => {
  const cachePath = "/tmp/mechanical-wings-state/credentials/github-copilot.token.json";
