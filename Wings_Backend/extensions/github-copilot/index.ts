import { ensureAuthProfileStore, listProfilesForProvider } from "mechanical-wings/plugin-sdk/agent-runtime";
import { definePluginEntry, type ProviderAuthContext } from "mechanical-wings/plugin-sdk/plugin-entry";
import { coerceSecretRef } from "mechanical-wings/plugin-sdk/provider-auth";
import { githubCopilotLoginCommand } from "mechanical-wings/plugin-sdk/provider-auth-login";
