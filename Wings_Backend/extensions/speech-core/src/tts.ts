...
import { normalizeChannelId, type ChannelId } from "mechanical-wings/plugin-sdk/channel-runtime";
import type {
  WingsConfig,
  TtsAutoMode,
  TtsConfig,
...
import { resolvePreferredWingsTmpDir } from "mechanical-wings/plugin-sdk/sandbox";
import { CONFIG_DIR, resolveUserPath, stripMarkdown } from "mechanical-wings/plugin-sdk/text-runtime";
import {
...
function sortSpeechProvidersForAutoSelection(cfg?: WingsConfig) {
...
function resolveRegistryDefaultSpeechProviderId(cfg?: WingsConfig): TtsProvider {
...
export function resolveTtsConfig(cfg: WingsConfig): ResolvedTtsConfig {
...
export function buildTtsSystemPromptHint(cfg: WingsConfig): string | undefined {
...
export function resolveTtsProviderOrder(primary: TtsProvider, cfg?: WingsConfig): TtsProvider[] {
...
export async function textToSpeech(params: {
  ...
  const tempRoot = resolvePreferredWingsTmpDir();
