...
} from "mechanical-wings/plugin-sdk/channel-pairing";
...
import { runStoppablePassiveMonitor } from "mechanical-wings/plugin-sdk/extension-shared";
import {
          ...
          if (changed) {
            if (nextSection && Object.keys(nextSection).length > 0) {
              ...
              if (Object.keys(nextChannels).length > 0) {
                nextCfg.channels = nextChannels as WingsConfig["channels"];
              } else {
