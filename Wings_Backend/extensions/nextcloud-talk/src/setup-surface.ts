import type { ChannelSetupInput } from "mechanical-wings/plugin-sdk/channel-setup";
...
import { hasConfiguredSecretInput } from "mechanical-wings/plugin-sdk/secret-input";
import {
...
export const nextcloudTalkSetupWizard: ChannelSetupWizard = {
  ...
  introNote: {
    ...
    lines: [
      ...
      '2) Run: ./occ talk:bot:install "Wings" "<shared-secret>" "<webhook-url>" --feature reaction',
