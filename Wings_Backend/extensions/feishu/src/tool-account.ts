...
import type { WingsPluginApi } from "../runtime-api.js";
import {
...
function readConfiguredDefaultAccountId(config: WingsPluginApi["config"]): string | undefined {
...
function resolveImplicitToolAccountId(params: {
  api: Pick<WingsPluginApi, "config">;
