...
import { isSecretRef, type WingsConfig } from "mechanical-wings/plugin-sdk/core";
import { safeParseJsonWithSchema, safeParseWithSchema } from "mechanical-wings/plugin-sdk/extension-shared";
import { z } from "zod";
...
export function listEnabledGoogleChatAccounts(cfg: WingsConfig): ResolvedGoogleChatAccount[] {
