...
export function resolveTavilySearchConfig(cfg?: WingsConfig): TavilySearchConfig {
...
export function resolveTavilyApiKey(cfg?: WingsConfig): string | undefined {
...
export function resolveTavilyBaseUrl(cfg?: WingsConfig): string {
  const search = resolveTavilySearchConfig(cfg);
  const configured =
