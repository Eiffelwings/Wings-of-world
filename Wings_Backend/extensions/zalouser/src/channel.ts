...
import { createAccountStatusSink } from "mechanical-wings/plugin-sdk/channel-lifecycle";
import { createPairingPrefixStripper } from "mechanical-wings/plugin-sdk/channel-pairing";
import {
  createEmptyChannelResult,
  createRawChannelSendResultAdapter,
} from "mechanical-wings/plugin-sdk/channel-send-result";
import { createStaticReplyToModeResolver } from "mechanical-wings/plugin-sdk/conversation-runtime";
...
function resolveZalouserOutboundChunkMode(cfg: WingsConfig, accountId?: string) {
  return getZalouserRuntime().channel.text.resolveChunkMode(cfg, "zalouser", accountId);
}

function resolveZalouserOutboundTextChunkLimit(cfg: WingsConfig, accountId?: string) {
