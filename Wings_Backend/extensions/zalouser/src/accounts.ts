...
function mergeZalouserAccountConfig(cfg: WingsConfig, accountId: string): ZalouserAccountConfig {
...
function resolveZalouserAccountBase(params: { cfg: WingsConfig; accountId?: string | null }) {
