...
} from "mechanical-wings/plugin-sdk/memory-core-host-engine-embeddings";
import { resolveUserPath } from "mechanical-wings/plugin-sdk/memory-core-host-engine-foundation";
import { getProviderEnvVars } from "mechanical-wings/plugin-sdk/provider-env-vars";
...
function formatLocalSetupError(err: unknown): string {
  ...
  return [
    ...
    missing
      ? "2) Reinstall Wings (this should install node-llama-cpp): npm i -g mechanical-wings@latest"
      : null,
