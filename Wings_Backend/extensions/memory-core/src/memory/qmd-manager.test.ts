...
const MCPORTER_STATE_KEY = Symbol.for("mechanical-wings.mcporterState");
...
vi.mock("mechanical-wings/plugin-sdk/memory-core-host-engine-foundation", async () => {
  const actual = await vi.importActual<
    typeof import("mechanical-wings/plugin-sdk/memory-core-host-engine-foundation")
  >("mechanical-wings/plugin-sdk/memory-core-host-engine-foundation");
  return {
    ...actual,
...
import type { WingsConfig } from "mechanical-wings/plugin-sdk/memory-core-host-engine-foundation";
import {
  requireNodeSqlite,
  resolveMemoryBackendConfig,
} from "mechanical-wings/plugin-sdk/memory-core-host-engine-storage";
...
describe("QmdMemoryManager", () => {
  ...
  async function createManager(params?: { mode?: "full" | "status"; cfg?: WingsConfig }) {
