...
function resolveQianfanPreset(cfg: WingsConfig): {
  api: ModelApi;
  baseUrl: string;
...
export function applyQianfanProviderConfig(cfg: WingsConfig): WingsConfig {
  return qianfanPresetAppliers.applyProviderConfig(cfg);
}

export function applyQianfanConfig(cfg: WingsConfig): WingsConfig {
