...
import type { WingsConfig } from "../../src/config/types.mechanical-wings.js";
...
vi.mock("mechanical-wings/plugin-sdk/provider-auth", async () => {
  const actual = await vi.importActual<typeof import("mechanical-wings/plugin-sdk/provider-auth")>(
    "mechanical-wings/plugin-sdk/provider-auth",
  );
  return {
    ...actual,
