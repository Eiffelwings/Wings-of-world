...
function mergeZaloAccountConfig(cfg: WingsConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: WingsConfig): ResolvedZaloAccount[] {
