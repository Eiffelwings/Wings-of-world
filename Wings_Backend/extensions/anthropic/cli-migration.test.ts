...
vi.mock("mechanical-wings/plugin-sdk/provider-auth", async (importActual) => {
  const actual = await importActual<typeof import("mechanical-wings/plugin-sdk/provider-auth")>();
  return {
    ...actual,
