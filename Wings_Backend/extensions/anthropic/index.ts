...
import { parseDurationMs } from "mechanical-wings/plugin-sdk/cli-runtime";
import {
  definePluginEntry,
...
import { normalizeModelCompat } from "mechanical-wings/plugin-sdk/provider-models";
import { fetchClaudeUsage } from "mechanical-wings/plugin-sdk/provider-usage";
...
function buildAnthropicAuthDoctorHint(params: {
  ...
  return [
    ...
    `Fix: run "${formatCliCommand("mechanical-wings doctor --yes")}"`,
  ].join("\n");
}
