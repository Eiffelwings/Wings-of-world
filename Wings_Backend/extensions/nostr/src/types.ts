...
function resolveConfiguredDefaultNostrAccountId(cfg: WingsConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: WingsConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: WingsConfig): string {
