# @mechanical-wings/nostr

Nostr DM channel plugin for Wings🪽 using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Wings🪽. It enables your bot to:
...
# Configure mechanical-wings to use local relay
