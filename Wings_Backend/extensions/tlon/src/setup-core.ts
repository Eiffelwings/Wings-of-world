...
export async function resolveTlonSetupConfigured(cfg: WingsConfig): Promise<boolean> {
...
export async function resolveTlonSetupStatusLines(cfg: WingsConfig): Promise<string[]> {
