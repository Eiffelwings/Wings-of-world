...
import { fetchWithSsrFGuard } from "mechanical-wings/plugin-sdk/infra-runtime";
import { getDefaultSsrFPolicy } from "../urbit/context.js";

// Default to Wings workspace media directory
const DEFAULT_MEDIA_DIR = path.join(homedir(), ".mechanical-wings", "workspace", "media", "inbound");
 ...
 * Format matches Wings's expected attachment structure.
 */
