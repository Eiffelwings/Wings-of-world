...
vi.mock("mechanical-wings/plugin-sdk/config-runtime", async () => {
  ...
  return {
    ...actual,
    loadConfig: () => config,
    resolveStorePath: vi.fn(() => "/tmp/mechanical-wings-sessions.json"),
...
vi.mock("mechanical-wings/plugin-sdk/security-runtime", async () => {
  const actual = await vi.importActual<typeof import("mechanical-wings/plugin-sdk/security-runtime")>(
    "mechanical-wings/plugin-sdk/security-runtime",
  );
  return {
    ...actual,
...
export function installSignalToolResultTestHooks() {
  beforeEach(async () => {
    const [{ resetInboundDedupe }, { resetSystemEventsForTest }] = await Promise.all([
      import("mechanical-wings/plugin-sdk/reply-runtime"),
      import("mechanical-wings/plugin-sdk/infra-runtime"),
    ]);
    resetInboundDedupe();
    config = {
