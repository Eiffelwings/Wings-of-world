...
import type { SignalAccountConfig } from "mechanical-wings/plugin-sdk/signal-core";
...
function mergeSignalAccountConfig(cfg: WingsConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: WingsConfig): ResolvedSignalAccount[] {
