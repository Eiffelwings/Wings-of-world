...
type WebSearchConfig = NonNullable<WingsConfig["tools"]>["web"] extends infer Web
  ? Web extends { search?: infer Search }
    ? Search
    : undefined
  : undefined;

type WebFetchConfig = NonNullable<WingsConfig["tools"]>["web"] extends infer Web
...
function resolveSearchConfig(cfg?: WingsConfig): WebSearchConfig {
...
function resolveFetchConfig(cfg?: WingsConfig): WebFetchConfig {
...
export function resolveFirecrawlSearchConfig(cfg?: WingsConfig): FirecrawlSearchConfig {
...
export function resolveFirecrawlFetchConfig(cfg?: WingsConfig): FirecrawlFetchConfig {
...
export function resolveFirecrawlApiKey(cfg?: WingsConfig): string | undefined {
...
export function resolveFirecrawlBaseUrl(cfg?: WingsConfig): string {
  const search = resolveFirecrawlSearchConfig(cfg);
  const fetch = resolveFirecrawlFetchConfig(cfg);
  const configured =
...
export function resolveFirecrawlOnlyMainContent(cfg?: WingsConfig, override?: boolean): boolean {
...
export function resolveFirecrawlMaxAgeMs(cfg?: WingsConfig, override?: number): number {
