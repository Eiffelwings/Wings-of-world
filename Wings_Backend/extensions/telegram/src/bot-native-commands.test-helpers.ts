...
import type { ChannelGroupPolicy } from "mechanical-wings/plugin-sdk/config-runtime";
import type { TelegramAccountConfig } from "mechanical-wings/plugin-sdk/config-runtime";
import type { RuntimeEnv } from "mechanical-wings/plugin-sdk/runtime-env";
...
type GetPluginCommandSpecsFn =
  typeof import("mechanical-wings/plugin-sdk/plugin-runtime").getPluginCommandSpecs;
type MatchPluginCommandFn = typeof import("mechanical-wings/plugin-sdk/plugin-runtime").matchPluginCommand;
type ExecutePluginCommandFn =
  typeof import("mechanical-wings/plugin-sdk/plugin-runtime").executePluginCommand;
...
type RecordInboundSessionMetaSafeFn =
  typeof import("mechanical-wings/plugin-sdk/conversation-runtime").recordInboundSessionMetaSafe;
...
vi.mock("mechanical-wings/plugin-sdk/plugin-runtime", () => ({
...
vi.mock("mechanical-wings/plugin-sdk/reply-runtime", async (importOriginal) => {
...
vi.mock("mechanical-wings/plugin-sdk/conversation-runtime", async (importOriginal) => {
...
vi.mock("mechanical-wings/plugin-sdk/channel-reply-pipeline", async (importOriginal) => {
  const actual =
    await importOriginal<typeof import("mechanical-wings/plugin-sdk/channel-reply-pipeline")>();
  return {
    ...actual,
...
export function createNativeCommandsHarness(params?: {
  ...
  const telegramDeps = {
    loadConfig: vi.fn(() => params?.cfg ?? ({} as WingsConfig)),
