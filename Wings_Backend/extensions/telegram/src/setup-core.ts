...
import type { ChannelSetupAdapter, ChannelSetupDmPolicy } from "mechanical-wings/plugin-sdk/setup";
...
export const TELEGRAM_TOKEN_HELP_LINES = [
  ...
  "Website: https://wings-of-world.ai",
];

export const TELEGRAM_USER_ID_HELP_LINES = [
  `1) DM your bot, then read from.id in \`${formatCliCommand("mechanical-wings logs --follow")}\` (safest)`,
