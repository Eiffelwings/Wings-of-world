...
import {
  ...
  type WingsConfig,
} from "mechanical-wings/plugin-sdk/account-resolution";
import { isTruthyEnvValue } from "mechanical-wings/plugin-sdk/infra-runtime";
import {
  listBoundAccountIds,
  resolveDefaultAgentBoundAccountId,
} from "mechanical-wings/plugin-sdk/routing";
import { formatSetExplicitDefaultInstruction } from "mechanical-wings/plugin-sdk/routing";
...
function listConfiguredAccountIds(cfg: WingsConfig): string[] {
...
export function listTelegramAccountIds(cfg: WingsConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: WingsConfig): string {
...
export function mergeTelegramAccountConfig(
  ...
  // See: https://github.com/mechanical-wings/mechanical-wings/issues/30673
...
export function listEnabledTelegramAccounts(cfg: WingsConfig): ResolvedTelegramAccount[] {
