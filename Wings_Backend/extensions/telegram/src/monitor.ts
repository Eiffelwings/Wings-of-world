...
import { resolveAgentMaxConcurrent } from "mechanical-wings/plugin-sdk/config-runtime";
...
import { waitForAbortSignal } from "mechanical-wings/plugin-sdk/runtime-env";
...
export function createTelegramRunnerOptions(cfg: WingsConfig): RunOptions<unknown> {
  return {
    sink: {
