...
import { resolveApiKeyForProvider } from "mechanical-wings/plugin-sdk/agent-runtime";
import type { ModelCatalogEntry } from "mechanical-wings/plugin-sdk/agent-runtime";
import {
  findModelInCatalog,
  loadModelCatalog,
  modelSupportsVision,
...
import { loadJsonFile, saveJsonFile } from "mechanical-wings/plugin-sdk/json-store";
import { AUTO_IMAGE_KEY_PROVIDERS, DEFAULT_IMAGE_MODELS } from "mechanical-wings/plugin-sdk/media-runtime";
import { resolveAutoImageModel } from "mechanical-wings/plugin-sdk/media-runtime";
import { describeImageFileWithModel } from "mechanical-wings/plugin-sdk/media-understanding-runtime";
import { logVerbose } from "mechanical-wings/plugin-sdk/runtime-env";
import { STATE_DIR } from "mechanical-wings/plugin-sdk/state-paths";
