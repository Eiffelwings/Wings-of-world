...
import {
  ...
  loadModelCatalog,
  modelSupportsVision,
} from "mechanical-wings/plugin-sdk/agent-runtime";
...
import { clearHistoryEntriesIfEnabled } from "mechanical-wings/plugin-sdk/reply-history";
...
import { resolveAutoTopicLabelConfig, generateTopicLabel } from "mechanical-wings/plugin-sdk/reply-runtime";
...
async function resolveStickerVisionSupport(cfg: WingsConfig, agentId: string) {
  try {
