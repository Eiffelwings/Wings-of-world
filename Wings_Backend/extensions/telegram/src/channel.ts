...
import { createAllowlistProviderRouteAllowlistWarningCollector } from "mechanical-wings/plugin-sdk/channel-policy";
...
import { createChannelDirectoryAdapter } from "mechanical-wings/plugin-sdk/directory-runtime";
import { buildPluginApprovalRequestMessage } from "mechanical-wings/plugin-sdk/infra-runtime";
import {
  resolveOutboundSendDep,
  type OutboundSendDeps,
} from "mechanical-wings/plugin-sdk/outbound-runtime";
import {
...
function hasTelegramExecApprovalDmRoute(cfg: WingsConfig): boolean {
  ...
  base: {
    ...
    gateway: {
      ...
      logoutAccount: async ({ accountId, cfg }) => {
        ...
        const nextCfg = { ...cfg } as WingsConfig;
