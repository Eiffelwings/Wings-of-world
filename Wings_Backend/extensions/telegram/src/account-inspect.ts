import { resolveAccountWithDefaultFallback } from "mechanical-wings/plugin-sdk/account-resolution";
import type { WingsConfig } from "mechanical-wings/plugin-sdk/config-runtime";
import { coerceSecretRef } from "mechanical-wings/plugin-sdk/config-runtime";
import { tryReadSecretFileSync } from "mechanical-wings/plugin-sdk/infra-runtime";
import { resolveDefaultSecretProviderAlias } from "mechanical-wings/plugin-sdk/provider-auth";
...
function inspectTokenValue(params: { cfg: WingsConfig; value: unknown }): {
  token: string;
