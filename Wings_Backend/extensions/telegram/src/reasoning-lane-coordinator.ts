import { formatReasoningMessage } from "mechanical-wings/plugin-sdk/agent-runtime";
import type { ReplyPayload } from "mechanical-wings/plugin-sdk/reply-runtime";
import { findCodeRegions, isInsideCode } from "mechanical-wings/plugin-sdk/text-runtime";
