...
type DescribeImageWithModel =
  typeof import("mechanical-wings/plugin-sdk/media-runtime").describeImageWithModel;
type TranscribeFirstAudio = typeof import("mechanical-wings/plugin-sdk/media-runtime").transcribeFirstAudio;
