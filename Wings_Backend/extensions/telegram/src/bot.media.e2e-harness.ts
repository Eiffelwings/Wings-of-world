...
import type { GetReplyOptions, MsgContext } from "mechanical-wings/plugin-sdk/reply-runtime";
...
type FetchRemoteMediaFn = typeof import("mechanical-wings/plugin-sdk/media-runtime").fetchRemoteMedia;
...
export const telegramBotDepsForTest: TelegramBotDeps = {
  loadConfig: (() =>
    ...
    }) as WingsConfig) as TelegramBotDeps["loadConfig"],
...
export async function mockMediaRuntimeModuleForTest(
  importOriginal: () => Promise<typeof import("mechanical-wings/plugin-sdk/media-runtime")>,
) {
...
vi.mock("mechanical-wings/plugin-sdk/media-runtime", mockMediaRuntimeModuleForTest);
...
vi.doMock("mechanical-wings/plugin-sdk/agent-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("mechanical-wings/plugin-sdk/agent-runtime")>();
  return {
    ...actual,
