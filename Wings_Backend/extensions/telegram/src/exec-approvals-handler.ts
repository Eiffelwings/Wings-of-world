...
import { GatewayClient } from "mechanical-wings/plugin-sdk/gateway-runtime";
import { createOperatorApprovalsGatewayClient } from "mechanical-wings/plugin-sdk/gateway-runtime";
import type { EventFrame } from "mechanical-wings/plugin-sdk/gateway-runtime";
import { resolveExecApprovalCommandDisplay } from "mechanical-wings/plugin-sdk/infra-runtime";
import {
  buildExecApprovalPendingReplyPayload,
  type ExecApprovalPendingReplyParams,
} from "mechanical-wings/plugin-sdk/infra-runtime";
import { resolveExecApprovalSessionTarget } from "mechanical-wings/plugin-sdk/infra-runtime";
import type { ExecApprovalRequest, ExecApprovalResolved } from "mechanical-wings/plugin-sdk/infra-runtime";
import { normalizeAccountId, parseAgentSessionKey } from "mechanical-wings/plugin-sdk/routing";
...
import { compileSafeRegex, testRegexWithBoundedInput } from "mechanical-wings/plugin-sdk/security-runtime";
...
function isHandlerConfigured(params: { cfg: WingsConfig; accountId: string }): boolean {
  const config = resolveTelegramExecApprovalConfig({
    cfg: params.cfg,
    accountId: params.accountId,
  });
