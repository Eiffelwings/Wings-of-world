...
describe("edge cases", () => {
  ...
  it("classifies extension-like tokens as file refs or domains", () => {
    const cases = [
      ...
      {
        name: ".co stays links",
        input: "Visit t.co and mechanical-wings.co",
        contains: ['<a href="http://t.co">', '<a href="http://mechanical-wings.co">'],
        notContains: ["<code>t.co</code>", "<code>mechanical-wings.co</code>"],
      },
      {
