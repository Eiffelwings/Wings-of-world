...
function shouldShowTelegramDmAccessWarning(cfg: WingsConfig, accountId: string): boolean {
...
function buildTelegramDmAccessWarningLines(accountId: string): string[] {
  ...
  return [
    ...
    "  " + formatCliCommand(`mechanical-wings config set ${configBase}.dmPolicy "allowlist"`),
    "  " + formatCliCommand(`mechanical-wings config set ${configBase}.allowFrom '["YOUR_USER_ID"]'`),
