...
} from "mechanical-wings/plugin-sdk/command-auth";
import {
...
import { getRuntimeConfigSnapshot } from "mechanical-wings/plugin-sdk/config-runtime";
...
import { danger, logVerbose } from "mechanical-wings/plugin-sdk/runtime-env";
...
export const registerTelegramNativeCommands = ({
  ...
  const loadFreshRuntimeConfig = (): WingsConfig => telegramDeps.loadConfig();
  const resolveFreshTelegramConfig = (runtimeCfg: WingsConfig): TelegramAccountConfig => {
    try {
