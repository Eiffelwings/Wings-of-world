...
type ResolveConfiguredBindingRouteFn =
  typeof import("mechanical-wings/plugin-sdk/conversation-runtime").resolveConfiguredBindingRoute;
type EnsureConfiguredBindingRouteReadyFn =
  typeof import("mechanical-wings/plugin-sdk/conversation-runtime").ensureConfiguredBindingRouteReady;
...
vi.mock("mechanical-wings/plugin-sdk/command-auth", async (importOriginal) => {
...
describe("registerTelegramNativeCommands — session metadata", () => {
  ...
  beforeEach(() => {
    ...
    sessionMocks.resolveStorePath.mockClear().mockReturnValue("/tmp/mechanical-wings-sessions.json");
