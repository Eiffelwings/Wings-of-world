...
function createCfg(): WingsConfig {
  return {
    channels: {
      telegram: {
        enabled: true,
...
function resolveAccount(cfg: WingsConfig, accountId: string): ResolvedTelegramAccount {
  return telegramPlugin.config.resolveAccount(cfg, accountId) as ResolvedTelegramAccount;
}

function createStartTelegramContext(cfg: WingsConfig, accountId: string) {
...
function startTelegramAccount(cfg: WingsConfig, accountId: string) {
...
function configureOpsProxyNetwork(cfg: WingsConfig) {
