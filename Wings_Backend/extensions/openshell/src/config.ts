...
import { buildPluginConfigSchema, type WingsPluginConfigSchema } from "mechanical-wings/plugin-sdk/core";
...
const DEFAULT_SOURCE = "mechanical-wings";
...
export function createOpenShellPluginConfigSchema(): WingsPluginConfigSchema {
