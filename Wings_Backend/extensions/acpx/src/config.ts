...
import { buildPluginConfigSchema } from "mechanical-wings/plugin-sdk/core";
import { z } from "mechanical-wings/plugin-sdk/zod";
import type { WingsPluginConfigSchema } from "../runtime-api.js";
...
function isAcpxPluginRoot(dir: string): boolean {
  return (
    fs.existsSync(path.join(dir, "mechanical-wings.plugin.json")) &&
...
export function createAcpxPluginConfigSchema(): WingsPluginConfigSchema {
