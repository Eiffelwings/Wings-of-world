...
This directory contains the **BlueBubbles external channel plugin** for Wings🪽.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `mechanical-wings/plugin-sdk` helpers.
