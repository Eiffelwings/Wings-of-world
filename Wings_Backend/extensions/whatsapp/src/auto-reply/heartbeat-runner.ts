import { appendCronStyleCurrentTimeLine } from "mechanical-wings/plugin-sdk/agent-runtime";
...
import { emitHeartbeatEvent, resolveIndicatorType } from "mechanical-wings/plugin-sdk/infra-runtime";
import { resolveHeartbeatVisibility } from "mechanical-wings/plugin-sdk/infra-runtime";
import {
  hasOutboundReplyContent,
  resolveSendableOutboundReplyParts,
} from "mechanical-wings/plugin-sdk/reply-payload";
import { resolveHeartbeatReplyPayload } from "mechanical-wings/plugin-sdk/reply-runtime";
import {
  DEFAULT_HEARTBEAT_ACK_MAX_CHARS,
  resolveHeartbeatPrompt,
  stripHeartbeatToken,
} from "mechanical-wings/plugin-sdk/reply-runtime";
import { getReplyFromConfig } from "mechanical-wings/plugin-sdk/reply-runtime";
import { HEARTBEAT_TOKEN } from "mechanical-wings/plugin-sdk/reply-runtime";
import { normalizeMainKey } from "mechanical-wings/plugin-sdk/routing";
import { getChildLogger } from "mechanical-wings/plugin-sdk/runtime-env";
import { redactIdentifier } from "mechanical-wings/plugin-sdk/text-runtime";
