...
vi.mock("mechanical-wings/plugin-sdk/agent-runtime", () => ({
...
vi.mock("mechanical-wings/plugin-sdk/config-runtime", async (importOriginal) => {
...
vi.mock("mechanical-wings/plugin-sdk/routing", async (importOriginal) => {
  const actual = await importOriginal<typeof import("mechanical-wings/plugin-sdk/routing")>();
  return {
    ...actual,
...
vi.mock("mechanical-wings/plugin-sdk/runtime-env", async (importOriginal) => {
  const actual = await importOriginal<typeof import("mechanical-wings/plugin-sdk/runtime-env")>();
  const logger = {
    child: () => logger,
...
vi.mock("mechanical-wings/plugin-sdk/text-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("mechanical-wings/plugin-sdk/text-runtime")>();
  return {
    ...actual,
    redactIdentifier,
  };
...
vi.mock("../auth-store.js", () => ({
  WA_WEB_AUTH_DIR: "/tmp/mechanical-wings-oauth/whatsapp/default",
  resolveDefaultWebAuthDir: () => "/tmp/mechanical-wings-oauth/whatsapp/default",
