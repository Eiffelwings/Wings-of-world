import { resolveIdentityNamePrefix } from "mechanical-wings/plugin-sdk/agent-runtime";
import {
  resolveInboundSessionEnvelopeContext,
  toLocationContext,
} from "mechanical-wings/plugin-sdk/channel-inbound";
import { formatInboundEnvelope } from "mechanical-wings/plugin-sdk/channel-inbound";
import { createChannelReplyPipeline } from "mechanical-wings/plugin-sdk/channel-reply-pipeline";
import { shouldComputeCommandAuthorized } from "mechanical-wings/plugin-sdk/command-auth";
import type { loadConfig } from "mechanical-wings/plugin-sdk/config-runtime";
import { resolveMarkdownTableMode } from "mechanical-wings/plugin-sdk/config-runtime";
import { recordSessionMetaFromInbound } from "mechanical-wings/plugin-sdk/config-runtime";
...
import type { getReplyFromConfig } from "mechanical-wings/plugin-sdk/reply-runtime";
...
} from "mechanical-wings/plugin-sdk/routing";
import { logVerbose, shouldLogVerbose } from "mechanical-wings/plugin-sdk/runtime-env";
import type { getChildLogger } from "mechanical-wings/plugin-sdk/runtime-env";
import {
  readStoreAllowFromForDmPolicy,
  resolvePinnedMainDmOwnerFromAllowlist,
  resolveDmGroupAccessWithCommandGate,
} from "mechanical-wings/plugin-sdk/security-runtime";
import { jidToE164, normalizeE164 } from "mechanical-wings/plugin-sdk/text-runtime";
