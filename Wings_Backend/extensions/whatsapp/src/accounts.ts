...
export function listWhatsAppAuthDirs(cfg: WingsConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: WingsConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: WingsConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: WingsConfig): ResolvedWhatsAppAccount[] {
