...
function buildNoImageGenerationModelConfiguredMessage(cfg: WingsConfig): string {
...
export function listRuntimeImageGenerationProviders(params?: { config?: WingsConfig }) {
