/**
 * Twitch channel plugin for Wings.
 *
...
import type { WingsConfig } from "../api.js";
 ...
 * for Wings. Supports message sending, receiving, access control, and
 * status monitoring.
 */
export const twitchPlugin: ChannelPlugin<ResolvedTwitchAccount> =
  createChatChannelPlugin<ResolvedTwitchAccount>({
    ...
    base: {
      ...
      config: {
        listAccountIds: (cfg: WingsConfig): string[] => listAccountIds(cfg),
        resolveAccount: (cfg: WingsConfig, accountId?: string | null): ResolvedTwitchAccount => {
        ...
        isConfigured: (_account: unknown, cfg: WingsConfig): boolean =>
