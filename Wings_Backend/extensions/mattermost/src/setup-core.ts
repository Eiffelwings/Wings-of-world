...
import { createSetupInputPresenceValidator } from "mechanical-wings/plugin-sdk/setup";
...
export function resolveMattermostAccountWithSecrets(cfg: WingsConfig, accountId: string) {
