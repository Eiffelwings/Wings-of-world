...
import { createAccountListHelpers, type WingsConfig } from "../runtime-api.js";
...
export function listEnabledMattermostAccounts(cfg: WingsConfig): ResolvedMattermostAccount[] {
