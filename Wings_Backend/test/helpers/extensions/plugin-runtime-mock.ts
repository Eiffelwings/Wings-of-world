import { DEFAULT_MODEL, DEFAULT_PROVIDER } from "mechanical-wings/plugin-sdk/agent-runtime";
import type { PluginRuntime } from "mechanical-wings/plugin-sdk/testing";
import { removeAckReactionAfterReply, shouldAckReaction } from "mechanical-wings/plugin-sdk/testing";
...
export function createPluginRuntimeMock(overrides: DeepPartial<PluginRuntime> = {}): PluginRuntime {
  const base: PluginRuntime = {
    ...
    state: {
      resolveStateDir: vi.fn(() => "/tmp/mechanical-wings"),
    },
    modelAuth: {
