...
async function createConversationRuntimeMock(
  importOriginal: () => Promise<typeof import("mechanical-wings/plugin-sdk/conversation-runtime")>,
) {
...
vi.mock("mechanical-wings/plugin-sdk/security-runtime", (importOriginal) =>
  createAllowFromRuntimeMock(importOriginal),
);

vi.mock("mechanical-wings/plugin-sdk/conversation-runtime", createConversationRuntimeMock);
vi.mock("mechanical-wings/plugin-sdk/conversation-runtime.js", createConversationRuntimeMock);
