...
export const es: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Editar ~/.mechanical-wings/mechanical-wings.json de forma segura.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "¿En el móvil? Copia la URL completa (incluyendo #token=...) desde mechanical-wings dashboard --no-open en tu escritorio.",
    },
    insecure: {
