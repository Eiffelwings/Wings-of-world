...
const WELCOME_SUGGESTIONS = [
  "Wings🪽 ทำอะไรได้บ้าง?",
  "สรุปงานล่าสุดให้หน่อย",
  "ช่วยตั้งค่าระบบ Wings",
  "ตรวจสอบสถานะระบบ",
];
      ...
      ${
        avatar
          ...
          : html`<div class="agent-chat__avatar agent-chat__avatar--logo">
            <img src=${logoUrl} alt="Wings" />
          </div>`
      }
      <h2>Wings🪽</h2>
      <div class="agent-chat__badges">
        <span class="agent-chat__badge"><img src=${logoUrl} alt="" /> Ready to fly</span>
      </div>
...
function buildChatItems(props: ChatProps): Array<ChatItem | MessageGroup> {
  ...
  for (let i = historyStart; i < history.length; i++) {
    ...
    const marker = raw["__mechanical-wings"] as Record<string, unknown> | undefined;
