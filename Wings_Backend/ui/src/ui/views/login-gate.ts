    ...
    <div class="login-gate">
      <div class="login-gate__card">
        <div class="login-gate__header">
          <img class="login-gate__logo" src=${faviconSrc} alt="Wings🪽" />
          <div class="login-gate__title">Wings🪽</div>
        ...
        <div class="login-gate__help">
          ...
          <ol class="login-gate__steps">
            ...
            <li>${t("overview.connection.step2")}<code>mechanical-wings dashboard --no-open</code></li>
