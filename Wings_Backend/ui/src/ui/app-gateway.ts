...
export function connectGateway(host: GatewayHost) {
  ...
  const client = new GatewayBrowserClient({
    ...
    clientName: "mechanical-wings-control-ui",
    clientVersion,
    mode: "webchat",
    ...
    onHello: (hello) => {
      ...
      void subscribeSessions(host as unknown as WingsApp);
      void loadAssistantIdentity(host as unknown as WingsApp);
      void loadAgents(host as unknown as WingsApp);
      void loadHealthState(host as unknown as WingsApp);
      void loadNodes(host as unknown as WingsApp, { quiet: true });
      void loadDevices(host as unknown as WingsApp, { quiet: true });
...
function handleTerminalChatEvent(
  ...
  if (runId && host.refreshSessionsAfterChat.has(runId)) {
    ...
    if (state === "final") {
      void loadSessions(host as unknown as WingsApp, {
  ...
  if (hadToolEvents && state === "final") {
    void loadChatHistory(host as unknown as WingsApp);
    return true;
  }
  return false;
}
...
function handleChatGatewayEvent(host: GatewayHost, payload: ChatEventPayload | undefined) {
  ...
  const state = handleChatEvent(host as unknown as WingsApp, payload);
