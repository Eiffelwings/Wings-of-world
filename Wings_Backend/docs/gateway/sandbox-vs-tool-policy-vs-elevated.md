...
Wings🪽 has three related (but different) controls:
...
Use the inspector to see what Wings🪽 is _actually_ doing:
...
- `group:nodes`: `nodes`
- `group:mechanical-wings`: all built-in Wings🪽 tools (excludes provider plugins)
