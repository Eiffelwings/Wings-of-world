...
- Install via CLI: `mechanical-wings plugins install @mechanical-wings/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `mechanical-wings plugins install ./extensions/zalo`
   - From npm (if published): `mechanical-wings plugins install @mechanical-wings/zalo`
...
This page reflects current Wings🪽 behavior for **Zalo Bot Creator / Marketplace bots**.
...
- Approve via:
  - `mechanical-wings pairing list zalo`
  - `mechanical-wings pairing approve zalo <CODE>`
...
This table summarizes current **Zalo Bot Creator / Marketplace bot** behavior in Wings🪽.
...
- Example: `mechanical-wings message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `mechanical-wings channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `mechanical-wings logs --follow`
