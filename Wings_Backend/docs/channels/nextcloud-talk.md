...
```bash
mechanical-wings plugins install @mechanical-wings/nextcloud-talk
```

Local checkout (when running from a git repo):

```bash
mechanical-wings plugins install ./extensions/nextcloud-talk
```
...
2. On your Nextcloud server, create a bot:
   ...
   ```bash
   ./occ talk:bot:install "Wings🪽" "<shared-secret>" "<webhook-url>" --feature reaction
   ```
...
- Approve via:
  - `mechanical-wings pairing list nextcloud-talk`
  - `mechanical-wings pairing approve nextcloud-talk <CODE>`
