---
summary: "Overview of Wings🪽 onboarding options and flows"
read_when:
...
Wings🪽 has two onboarding paths. Both configure auth, the Gateway, and
...
| **Command**    | `mechanical-wings onboard`                     | Launch the app            |
...
CLI command docs: [`mechanical-wings onboard`](/cli/onboard)

## macOS app onboarding

Open the Wings🪽 app. The first-run wizard walks you through the same steps
