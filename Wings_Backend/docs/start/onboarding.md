---
summary: "First-run setup flow for Wings🪽 (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Wings🪽">
...
<Step title="CLI">
  ...
  The app can install the global `mechanical-wings` CLI via npm/pnpm so terminal
