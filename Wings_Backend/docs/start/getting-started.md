---
summary: "Get Wings🪽 installed and run your first chat in minutes."
read_when:
...
Install Wings🪽, run onboarding, and chat with your AI assistant — all in
...
<Accordion title="Advanced: environment variables">
  If you run Wings🪽 as a service account or want custom paths:
