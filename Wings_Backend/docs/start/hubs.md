---
summary: "Hubs that link to every Wings🪽 doc"
read_when:
...
<Note>
If you are new to Wings🪽, start with [Getting Started](/start/getting-started).
</Note>
...
- [Wings🪽 assistant](/start/mechanical-wings)
