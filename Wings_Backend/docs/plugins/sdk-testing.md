...
summary: "Testing utilities and patterns for Wings🪽 plugins"
read_when:
...
Reference for test utilities, patterns, and lint enforcement for Wings🪽
plugins.
...
**Import:** `mechanical-wings/plugin-sdk/testing`
...
} from "mechanical-wings/plugin-sdk/testing";
```
...
import { installCommonResolveTargetErrorCases } from "mechanical-wings/plugin-sdk/testing";
...
import type { PluginRuntime } from "mechanical-wings/plugin-sdk/runtime-store";
...
1. **No monolithic root imports** -- `mechanical-wings/plugin-sdk` root barrel is rejected
...
Wings🪽 uses Vitest with V8 coverage thresholds. For plugin tests:
