...
summary: "Step-by-step guide to building a messaging channel plugin for Wings🪽"
read_when:
  - You are building a new messaging channel plugin
  - You want to connect Wings🪽 to a messaging platform
  - You need to understand the ChannelPlugin adapter surface
---

# Building Channel Plugins

This guide walks through building a channel plugin that connects Wings🪽 to a
...
Channel plugins do not need their own send/edit/react tools. Wings🪽 keeps one
...
<Steps>
  <Step title="Package and manifest">
    ...
    ```json package.json
    {
      "name": "@myorg/mechanical-wings-acme-chat",
      "version": "1.0.0",
      "type": "module",
      "mechanical-wings": {
        "extensions": ["./index.ts"],
        ...
        "channel": {
          "id": "acme-chat",
          "label": "Acme Chat",
          "blurb": "Connect Wings🪽 to Acme Chat."
        }
      }
    }
    ```
  ...
  <Step title="Build the channel plugin object">
    ...
    import type { Wings🪽Config } from "mechanical-wings/plugin-sdk/core";
  ...
  <Step title="Add a setup entry">
    ...
    Wings🪽 loads this instead of the full entry when the channel is disabled
  ...
  <Step title="Handle inbound messages">
    ...
    Wings🪽. The typical pattern is a webhook that verifies the request and
    ...
    registerFull(api) {
      api.registerHttpRoute({
        ...
        handler: async (req, res) => {
          ...
          // Your inbound handler dispatches the message to Wings🪽.
...
├── package.json              # mechanical-wings.channel metadata
├── mechanical-wings.plugin.json      # Manifest with config schema
