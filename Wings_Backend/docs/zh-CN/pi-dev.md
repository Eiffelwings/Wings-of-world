...
本指南总结了在 Wings🪽 中开发 Pi 集成的合理工作流程。
...
状态存储在 Wings🪽 状态目录下。默认为 `~/.mechanical-wings`。如果设置了 `OPENCLAW_STATE_DIR`，则使用该目录。

要重置所有内容：

- `mechanical-wings.json` 用于配置
...
- https://docs.wings-of-world.ai/testing
- https://docs.wings-of-world.ai/start/getting-started
