...
mechanical-wings system heartbeat last
mechanical-wings logs --follow
mechanical-wings config get agents.defaults.heartbeat
mechanical-wings channels status --probe
```
...
```bash
mechanical-wings config get agents.defaults.heartbeat.activeHours
mechanical-wings config get agents.defaults.heartbeat.activeHours.timezone
mechanical-wings config get agents.defaults.userTimezone || echo "agents.defaults.userTimezone not set"
mechanical-wings cron list
mechanical-wings logs --follow
```
