...
You can point Wings🪽 at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Wings🪽
...
- [Anthropic provider](/providers/anthropic) - Native Wings🪽 integration with Claude setup-token or API keys
