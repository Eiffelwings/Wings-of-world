---
summary: "Use Qianfan's unified API to access many models in Wings🪽"
read_when:
...
3. Wings🪽 installed on your system
...
4. Copy the API key for use with Wings🪽

## CLI setup

```bash
mechanical-wings onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Wings🪽 Configuration](/gateway/configuration)
