---
summary: "Run Wings🪽 with SGLang (OpenAI-compatible self-hosted server)"
read_when:
  - You want to run Wings🪽 against a local SGLang server
...
Wings🪽 can connect to SGLang using the `openai-completions` API.

Wings🪽 can also **auto-discover** available models from SGLang when you opt
...
define `models.providers.sglang`, Wings🪽 will query:
