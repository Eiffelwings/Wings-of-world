---
summary: "Use NVIDIA's OpenAI-compatible API in Wings🪽"
read_when:
  - You want to use NVIDIA models in Wings🪽
...
mechanical-wings onboard --auth-choice skip
mechanical-wings models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
