---
summary: "Use Xiaomi MiMo models with Wings🪽"
read_when:
  - You want Xiaomi MiMo models in Wings🪽
...
Xiaomi MiMo is the API platform for **MiMo** models. Wings🪽 uses the Xiaomi
...
```bash
mechanical-wings onboard --auth-choice xiaomi-api-key
# or non-interactive
mechanical-wings onboard --auth-choice xiaomi-api-key --xiaomi-api-key "$XIAOMI_API_KEY"
```
