---
summary: "Wings🪽 tools and plugins overview: what the agent can do and how to extend it"
read_when:
  - You want to understand what tools Wings🪽 provides
...
<Steps>
  ...
  <Step title="Plugins package everything together">
    ...
    Some plugins are **core** (shipped with Wings🪽), others are **external**
...
These tools ship with Wings🪽 and are available without installing any plugins:
...
| `group:nodes`      | nodes                                                                                                     |
| `group:mechanical-wings`   | All built-in Wings🪽 tools (excludes plugin tools)                                                       |
